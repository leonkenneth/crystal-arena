...
const samplePlayerHand: CardData[] = [
  {
    ...
    color: "#c9a959",
    label: "Knight",
    description: "A brave warrior who fights for honor.",
    attack: 4,
    health: 5,
  },
  {
    ...
    color: "#6b9bc3",
    label: "Mage",
    description: "Wields powerful arcane magic.",
    attack: 3,
    health: 3,
  },
  {
    ...
    color: "#c75d5d",
    label: "Archer",
    description: "Strikes from a distance with deadly precision.",
    attack: 5,
    health: 2,
  },
  {
    ...
    color: "#7bc275",
    label: "Healer",
    description: "Restores health to wounded allies.",
    attack: 1,
    health: 4,
  },
  {
    ...
    color: "#9b7bc2",
    label: "Rogue",
    description: "Sneaky assassin who deals double damage from stealth.",
    attack: 6,
    health: 2,
  },
];
...
const sampleOpponentBattlefieldFrontRow: CardData[] = [
  {
    ...
    color: "#c75d5d",
    label: "Dragon",
    description: "Ancient beast that breathes fire.",
    attack: 8,
    health: 8,
  },
];
...
const sampleOpponentBattlefieldBackRow: CardData[] = [
  {
    ...
    color: "#9b7bc2",
    label: "Demon",
    description: "Creature from the underworld.",
    attack: 6,
    health: 5,
  },
  {
...
const samplePlayerDeck: CardData[] = [
  ...
  },
  {
    ...
    color: "#4a6fa5",
    label: "Wizard",
    description: "Master of elemental spells.",
    attack: 4,
    health: 2,
  },
  {
    ...
    color: "#7b4a7c",
    label: "Warlock",
    description: "Dark mage who bargains with demons.",
    attack: 7,
    health: 3,
  },
];
...
const sampleOpponentDeck: CardData[] = [
  ...
  },
  {
    ...
    color: "#7c6a5d",
    label: "Golem",
    description: "Construct of stone and magic.",
    attack: 3,
    health: 10,
  },
  {
    ...
    color: "#5d5d7c",
    label: "Specter",
    description: "Ghostly apparition that ignores armor.",
    attack: 5,
    health: 3,
  },
  {
  ...
  },
  {
    ...
    color: "#8b4513",
    label: "Ogre",
    description: "Brutish creature with immense strength.",
    attack: 7,
    health: 6,
  },
];
...
const samplePlayerGraveyard: CardData[] = [
  ...
  },
  {
    ...
    color: "#666",
    label: "Scout",
    description: "Reconnaissance unit, now deceased.",
    attack: 1,
    health: 1,
  },
  {
    ...
    color: "#777",
    label: "Squire",
    description: "Knight in training, met an early end.",
    attack: 2,
    health: 3,
  },
];
...
const sampleOpponentGraveyard: CardData[] = [
  {
    ...
    color: "#555",
    label: "Imp",
    description: "Minor demon, easily dispatched.",
    attack: 1,
    health: 1,
  },
  {
    ...
    color: "#666",
    label: "Skeleton",
    description: "Reanimated bones, now truly dead.",
    attack: 2,
    health: 1,
  },
  {
    ...
    color: "#777",
    label: "Zombie",
    description: "Undead creature, returned to rest.",
    attack: 3,
    health: 2,
  },
  {
    ...
    color: "#888",
    label: "Ghoul",
    description: "Flesh-eating monster, destroyed.",
    attack: 4,
    health: 3,
  },
  {
    ...
    color: "#999",
    label: "Wraith",
    description: "Vengeful spirit, banished.",
    attack: 5,
    health: 2,
  },
];
...
const samplePlayerExile: CardData[] = [
  {
    ...
    color: "#4a4a5a",
    label: "Banished",
    description: "Removed from the game entirely.",
    attack: 3,
    health: 3,
  },
];
...
const sampleOpponentExile: CardData[] = [
  {
    ...
    color: "#5a4a4a",
    label: "Exiled",
    description: "Cast into the void.",
    attack: 4,
    health: 2,
  },
  {
    ...
    color: "#4a5a4a",
    label: "Erased",
    description: "Wiped from existence.",
    attack: 2,
    health: 5,
  },
];
...
const samplePlayerSideHand: CardData[] = [
  {
    ...
    color: "#d4a574",
    label: "Reserve",
    description: "A card held in reserve for special tactics.",
    attack: 3,
    health: 4,
  },
  {
    ...
    color: "#74a5d4",
    label: "Backup",
    description: "Emergency reinforcement unit.",
    attack: 2,
    health: 3,
  },
  {
    ...
    color: "#a574d4",
    label: "Secret",
    description: "A hidden ace up your sleeve.",
    attack: 4,
    health: 2,
  },
];
...
const sampleStack: StackEffect<CardData>[] = [
  {
    card: {
      ...
      color: "#e8a040",
      label: "Fireball",
      description: "Deals 5 damage to target creature.",
      attack: 5,
    },
    targetCardIds: ["111"],
  },
...
function renderSampleCardMesh(card: CardData): React.ReactNode {
  return <Card faceDown={false} color={card.color} label={card.label} />;
}
...
export default function DummyGameBoard() {
  ...
  return (
    <GameBoard<CardData>
      ...
      onExileClick={(isOpponent) =>
        console.log("Exile clicked:", isOpponent ? "opponent" : "player")
      }
      onPrizeCardsClick={(isOpponent) =>
        console.log("Prize cards clicked:", isOpponent ? "opponent" : "player")
      }
