...
export default forwardRef(function CardContainer({ dataCardId, children, isInteractable, isPlayable, isTapped, isSelected, size, ...props }: Props, ref: React.Ref<HTMLDivElement>) {
