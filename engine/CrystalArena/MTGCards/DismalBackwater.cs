namespace CrystalArena.CardsMainDeck
{
    ...
    public class DismalBackwater : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Dismal Backwater")
                .Type("Backup")
                .Text(
                    "Dismal Backwater enters the battlefield tapped.{EOL}When Dismal Backwater enters the battlefield, you gain 1 life.{EOL}{T}: Add {U} or {B} to your mana pool."
                )
