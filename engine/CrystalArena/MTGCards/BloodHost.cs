  ...
  public class BloodHost : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{1}{B}, Sacrifice another forward: Put a +1/+1 counter on Blood Host and you gain 2 life.")
        .FlavorText("It would be ill-mannered to decline his invitation. It would be ill-advised to accept it.")
        .Power(3)
        .Toughness(3)
        .ActivatedAbility(p =>
          {
            p.Text = "{1}{B}, Sacrifice another forward: Put a +1/+1 counter on Blood Host and you gain 2 life.";
