  ...
  public class CaveTiger : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{2}{G}")
        .Type("Forward Cat")
        .Text("Whenever Cave Tiger becomes blocked by a forward, Cave Tiger gets +1/+1 until end of turn.")
        .FlavorText(
        ...
        .TriggeredAbility(p =>
          {
            p.Text = "Whenever Cave Tiger becomes blocked by a forward, Cave Tiger gets +1/+1 until end of turn.";
