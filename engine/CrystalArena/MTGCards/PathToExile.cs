namespace CrystalArena.CardsMainDeck
{
    ...
    public class PathToRemovedFromPlay : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Path to RemoveFromPlay")
                .ManaCost("{W}")
                .Type("Summon")
                .Text(
                    "RemoveFromPlay target forward. Its controller may search his or her library for a basic backup card, put that card onto the battlefield tapped, then shuffle his or her library."
                )
                .Cast(p =>
                {
                    p.Effect = () =>
