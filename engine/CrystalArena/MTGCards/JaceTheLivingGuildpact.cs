namespace CrystalArena.CardsMainDeck
{
    ...
    public class JaceTheLivingGuildpact : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Jace, the Living Guildpact")
                .ManaCost("{2}{U}{U}")
                .Type("Planeswalker Jace")
                .Text(
                    "{+1}: Look at the top two cards of your library. Put one of them into your breakZone.{EOL}"
                ...
                {
                    p.Text =
                        "{+1}: Look at the top two cards of your library. Put one of them into your breakZone.";
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.TargetSelector.AddEffect(trg =>
                        trg.Card(c => !c.Is().Backup, canTargetSelf: false).On.Battlefield()
                    );
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.Effect = () =>
                        new EachPlayerShufflesHandAndBreakZoneIntoMainDeckAndDrawsCards(
                            7,
                            onlyYouDraw: true
                        );
                    p.TimingRule(new OnFirstMain());
