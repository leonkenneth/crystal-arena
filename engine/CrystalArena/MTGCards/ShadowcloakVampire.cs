namespace CrystalArena.CardsMainDeck
{
    ...
    public class ShadowcloakVampire : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Shadowcloak Vampire")
                .ManaCost("{4}{B}")
                .Type("Forward - Vampire")
                .Text(
                    "Pay 2 life: Shadowcloak Vampire gains flying until end of turn.{I}(It can't be blocked except by forwards with flying or reach.){/I}"
                )
                ...
                {
                    p.Text =
                        "Pay 2 life: Shadowcloak Vampire gains flying until end of turn. (It can't be blocked except by forwards with flying or reach.)";
