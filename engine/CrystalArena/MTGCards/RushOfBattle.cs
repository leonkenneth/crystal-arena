namespace CrystalArena.CardsMainDeck
{
    ...
    public class RushOfBattle : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rush of Battle")
                .ManaCost("{3}{W}")
                .Type("Sorcery")
                .Text(
                    "Forwards you control get +2/+1 until end of turn. Warrior forwards you control gain lifelink until end of turn.{I}(Damage dealt by those Warriors also causes their controller to gain that much life.){/I}"
                )
