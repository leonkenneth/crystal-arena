namespace CrystalArena.CardsMainDeck
{
    ...
    public class TranquilCove : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Tranquil Cove")
                .Type("Backup")
                .Text(
                    "Tranquil Cove enters the battlefield tapped.{EOL}When Tranquil Cove enters the battlefield, you gain 1 life.{EOL}{T}: Add {W} or {U} to your mana pool."
                )
