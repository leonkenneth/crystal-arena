namespace CrystalArena.CardsMainDeck
{
    ...
    public class SwiftwaterCliffs : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Swiftwater Cliffs")
                .Type("Backup")
                .Text(
                    "Swiftwater Cliffs enters the battlefield tapped.{EOL}When Swiftwater Cliffs enters the battlefield, you gain 1 life.{EOL}{T}: Add {U} or {R} to your mana pool."
                )
