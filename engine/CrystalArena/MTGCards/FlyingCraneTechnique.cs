  ...
  public class FlyingCraneTechnique : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{3}{U}{R}{W}")
        .Type("Summon")
        .Text("Untap all forwards you control. They gain flying and double strike until end of turn.")
        ...
        .Cast(p =>
        {
          p.Effect = () => new CompoundEffect(
            new UntapEachPermanent(filter: c => c.Is().Forward, controlledBy: ControlledBy.SpellOwner),
