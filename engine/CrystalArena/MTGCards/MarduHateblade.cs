namespace CrystalArena.CardsMainDeck
{
    ...
    public class MarduHateblade : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Mardu Hateblade")
                .ManaCost("{W}")
                .Type("Forward — Human Warrior")
                .Text(
                    "{B}: Mardu Hateblade gains deathtouch until end of turn.{I}(Any amount of damage it deals to a forward is enough to destroy it.){/I}"
                )
                .FlavorText(
