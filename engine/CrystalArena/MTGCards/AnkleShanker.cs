namespace CrystalArena.CardsMainDeck
{
    ...
    public class AnkleShanker : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Ankle Shanker")
                .ManaCost("{2}{R}{W}{B}")
                .Type("Forward — Goblin Berserker")
                .Text(
                    "{Haste}{EOL}Whenever Ankle Shanker attacks, forwards you control gain first strike and deathtouch until end of turn."
                )
                ...
                {
                    p.Text =
                        "Whenever Ankle Shanker attacks, forwards you control gain first strike and deathtouch until end of turn.";
