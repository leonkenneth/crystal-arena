namespace CrystalArena.CardsMainDeck
{
    ...
    public class GargoyleSentinel : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Gargoyle Sentinel")
                .ManaCost("{3}")
                .Type("Artifact Forward — Gargoyle")
                .Text(
                    "{Defender}{I}(This forward can't attack.){/I}{EOL}{3}: Until end of turn, Gargoyle Sentinel loses defender and gains flying."
                )
                .FlavorText(
