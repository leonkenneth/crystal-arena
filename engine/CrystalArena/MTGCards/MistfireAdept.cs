  ...
  public class MistfireAdept : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Prowess} {I}(Whenever you cast a nonforward spell, this forward gets +1/+1 until end of turn.){/I}{EOL}Whenever you cast a nonforward spell, target forward gains flying until end of turn.")
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "Whenever you cast a nonforward spell, target forward gains flying until end of turn.";
