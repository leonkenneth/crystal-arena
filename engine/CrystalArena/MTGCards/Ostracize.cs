namespace CrystalArena.CardsMainDeck
{
    ...
    public class Ostracize : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Ostracize")
                .ManaCost("{B}")
                .Type("Sorcery")
                .Text(
                    "Target opponent reveals his or her hand. You choose a forward card from it. That player discards that card."
                )
