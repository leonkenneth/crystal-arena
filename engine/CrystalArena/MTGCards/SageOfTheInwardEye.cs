namespace CrystalArena.CardsMainDeck
{
    ...
    public class SageOfTheInwardEye : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Sage of the Inward Eye")
                .ManaCost("{2}{U}{R}{W}")
                .Type("Forward — Djinn Wizard")
                .Text(
                    "{Flying}{EOL}Whenever you cast a nonforward spell, forwards you control gain lifelink until end of turn."
                )
                ...
                {
                    p.Text =
                        "Whenever you cast a nonforward spell, forwards you control gain lifelink until end of turn.";
                    p.Trigger(
