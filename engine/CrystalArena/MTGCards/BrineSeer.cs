namespace CrystalArena.CardsMainDeck
{
    ...
    public class BrineSeer : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Brine Seer")
                .ManaCost("{3}{U}")
                .Type("Forward Human Wizard")
                .Text(
                    "{2}{U},{T}: Reveal any number of water cards in your hand. Counter target spell unless its controller pays {1} for each card revealed this way."
                )
                .Power(1)
                .Toughness(1)
                .ActivatedAbility(p =>
                {
                    ...
                    p.Cost = new AggregateCost(new PayMana("{2}{U}".Parse()), new Tap());
