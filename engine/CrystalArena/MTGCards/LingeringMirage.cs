namespace CrystalArena.CardsMainDeck
{
    ...
    public class LingeringMirage : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Lingering Mirage")
                .ManaCost("{1}{U}")
                .Type("Monster Aura")
                .Text(
                    "{Enchant backup}{EOL}Enchanted backup is an Island.{EOL}Cycling {2} ({2}, Discard this card: Draw a card.)"
                )
                .FlavorText(
                ...
                {
                    p.Effect = () =>
                        new Attach(() => new ChangeBasicBackupSubtype("island", replace: true));
