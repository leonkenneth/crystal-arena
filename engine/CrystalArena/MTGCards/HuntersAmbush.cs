namespace CrystalArena.CardsMainDeck
{
    ...
    public class HuntersAmbush : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Hunter's Ambush")
                .ManaCost("{2}{G}")
                .Type("Summon")
                .Text(
                    "Prevent all combat damage that would be dealt by nongreen forwards this turn."
                )
                .FlavorText(
                ...
                {
                    p.Effect = () =>
                        new PreventAllCombatDamage(filter: card => !card.HasColor(CardColor.Wind));
