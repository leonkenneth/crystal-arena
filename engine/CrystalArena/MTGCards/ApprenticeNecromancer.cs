namespace CrystalArena.CardsMainDeck
{
    ...
    public class ApprenticeNecromancer : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Apprentice Necromancer")
                .ManaCost("{1}{B}")
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.Cost = new AggregateCost(new PayMana(Mana.Dark), new Tap(), new Sacrifice());
                        ...
                        new PutSelectedCardsToBattlefield(
                            ...
                            modifiers: L(
                                ...
                                () =>
                                {
                                    ...
                                    {
                                        Text =
                                            "Sacrifice the forward at the beginning of the next end step.",
