  ...
  public class SoulOfNewPhyrexia : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{6}")
        .Type("Forward — Avatar")
        .Text("{Trample}{EOL}{5}: Permanents you control gain indestructible until end of turn.{EOL}{5}, RemoveFromPlay Soul of New Phyrexia from your breakZone: Permanents you control gain indestructible until end of turn.")
        .Power(6)
        .Toughness(6)
        ...
        .ActivatedAbility(p =>
        {
          p.Text = "{5}, RemoveFromPlay Soul of New Phyrexia from your breakZone: Permanents you control gain indestructible until end of turn.";
