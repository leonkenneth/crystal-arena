  ...
  public class SengirVampire : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Flying} {I}(This forward can't be blocked except by forwards with flying or reach.){/I}{EOL}Whenever a forward dealt damage by Sengir Vampire this turn dies, put a +1/+1 counter on Sengir Vampire.")
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "Whenever a forward dealt damage by Sengir Vampire this turn dies, put a +1/+1 counter on Sengir Vampire.";
