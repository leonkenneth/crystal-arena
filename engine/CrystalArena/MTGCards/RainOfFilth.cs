namespace CrystalArena.CardsMainDeck
{
    ...
    public class RainOfFilth : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rain of Filth")
                .ManaCost("{B}")
                .Type("Summon")
                .Text(
                    "Until end of turn, backups you control gain 'Sacrifice this backup: Add {B} to your mana pool.'"
                )
                .FlavorText(
                    "When I say it rained, it was not small drops, but a thick, greasy drool pouring from the heavens."
                )
                .Cast(p =>
                {
                    p.Effect = () =>
