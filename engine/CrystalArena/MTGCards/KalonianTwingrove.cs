  ...
  public class KalonianTwinCrystalArena : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "When Kalonian TwinCrystalArena enters the battlefield, put a wind Treefolk Warrior forward token onto the battlefield with \"This forward's power and toughness are each equal to the number of Forests you control.\"";
            ...
            p.Effect = () => new CreateTokens(
              ...
              token: Card
                ...
                .Text("This forward's power and toughness are each equal to the number of Forests you control.")
