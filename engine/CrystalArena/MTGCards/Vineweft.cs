namespace CrystalArena.CardsMainDeck
{
    ...
    public class Vineweft : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Vineweft")
                .ManaCost("{G}")
                .Type("Monster — Aura")
                .Text(
                    "Enchant forward{EOL}Enchanted forward gets +1/+1.{EOL}{4}{G}: Return Vineweft from your breakZone to your hand."
                )
                .FlavorText("Fortified by the wilds.")
                .Cast(p =>
                {
                    p.Effect = () =>
                        new Attach(() => new AddPowerAndToughness(1, 1)).SetTags(
