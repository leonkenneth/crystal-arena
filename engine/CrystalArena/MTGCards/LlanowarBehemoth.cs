  ...
  public class LlanowarBehemoth : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("Tap an untapped forward you control: Llanowar Behemoth gets +1/+1 until end of turn.")
        .FlavorText(
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "Tap an untapped forward you control: Llanowar Behemoth gets +1/+1 until end of turn.";
            p.Cost = new Tap();
