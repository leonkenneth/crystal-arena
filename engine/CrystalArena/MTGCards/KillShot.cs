namespace CrystalArena.CardsMainDeck
{
    ...
    public class KillShot : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Kill Shot")
                .ManaCost("{2}{W}")
                .Type("Summon")
                .Text("Destroy target attacking forward.")
                .FlavorText(
                ...
                .Cast(p =>
                {
                    ...
                    p.TargetSelector.AddEffect(
                        trg => trg.Is.Card(c => c.Is().Forward && c.IsAttacker).On.Battlefield(),
                        trg =>
                        {
                            trg.Message = "Select target attacking forward.";
                        }
                    );
