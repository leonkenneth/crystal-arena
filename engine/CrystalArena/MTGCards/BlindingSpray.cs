namespace CrystalArena.CardsMainDeck
{
    ...
    public class BlindingSpray : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Blinding Spray")
                .ManaCost("{4}{U}")
                .Type("Summon")
                .Text(
                    "Forwards your opponents control get -4/-0 until end of turn.{EOL}Draw a card."
                )
                .FlavorText(
                    "\"The stronger our enemies seem, the more vulnerable they are.\"{EOL}—Sultai secret"
                )
                .Cast(p =>
                {
                    p.Effect = () =>
