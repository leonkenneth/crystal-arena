  ...
  public class PhyrexianDebaser : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Flying}{EOL}{T}, Sacrifice Phyrexian Debaser: Target forward gets -2/-2 until end of turn.")
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "{T}, Sacrifice Phyrexian Debaser: Target forward gets -2/-2 until end of turn.";
