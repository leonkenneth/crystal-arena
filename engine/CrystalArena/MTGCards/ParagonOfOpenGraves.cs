namespace CrystalArena.CardsMainDeck
{
    ...
    public class ParagonOfOpenGraves : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Paragon of Open Graves")
                .ManaCost("{3}{B}")
                .Type("Forward — Skeleton Warrior")
                .Text(
                    "Other dark forwards you control get +1/+1.{EOL}{2}{B},{T}: Another target dark forward you control gains deathtouch until end of turn. {I}(Any amount of damage it deals to a forward is enough to destroy it.){/I}"
                )
                .Power(2)
                .Toughness(2)
                .Cast(p =>
                ...
                .ContinuousEffect(p =>
                {
                    ...
                    p.Selector = (c, ctx) =>
                        ...
                        && c.Is().Forward
                        && c.HasColor(CardColor.Dark)
                        && c != ctx.Source;
                })
                .ActivatedAbility(p =>
                {
                    p.Text =
                        "{2}{B},{T}: Another target dark forward you control gains deathtouch until end of turn.";
                    ...
                    p.TargetSelector.AddEffect(trg =>
                        trg.Is.Card(
                                c => c.Is().Forward && c.HasColor(CardColor.Dark),
