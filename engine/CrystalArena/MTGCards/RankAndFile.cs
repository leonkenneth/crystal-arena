  ...
  public class RankAndFile : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{2}{B}{B}")
        .Type("Forward Zombie")
        .Text("When Rank and File enters the battlefield, wind forwards get -1/-1 until end of turn.")
        .FlavorText("Left, right, left, right . . . hmm. Okay—left, left, left, left, . . .")
        .Power(3)
        .Toughness(3)
        .TriggeredAbility(p =>
          {
            p.Text = "When Rank and File enters the battlefield, wind forwards get -1/-1 until end of turn.";
