namespace CrystalArena.CardsMainDeck
{
    ...
    public class BloodsoakedChampion : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Bloodsoaked Champion")
                .ManaCost("{B}")
                .Type("Forward — Human Warrior")
                .Text(
                    "Bloodsoaked Champion can't block.{EOL}{I}Raid{/I} — {1}{B}: Return Bloodsoaked Champion from your breakZone to the battlefield. Activate this ability only if you attacked with a forward this turn."
                )
                ...
                {
                    p.Text =
                        "{1}{B}: Return Bloodsoaked Champion from your breakZone to the battlefield.";
