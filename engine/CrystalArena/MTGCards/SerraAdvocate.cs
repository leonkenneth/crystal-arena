namespace CrystalArena.CardsMainDeck
{
    ...
    public class SerraAdvocate : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Serra Advocate")
                .ManaCost("{3}{W}")
                .Type("Forward Angel")
                .Text(
                    "{Flying}{EOL}{T}: Target attacking or blocking forward gets +2/+2 until end of turn."
                )
                .FlavorText(
                ...
                {
                    p.Text =
                        "{T}: Target attacking or blocking forward gets +2/+2 until end of turn.";
                    p.Cost = new Tap();
                    p.Effect = () =>
