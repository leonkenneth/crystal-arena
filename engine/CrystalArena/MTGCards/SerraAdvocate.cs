  ...
  public class SerraAdvocate : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{3}{W}")
        .Type("Forward Angel")
        .Text("{Flying}{EOL}{T}: Target attacking or blocking forward gets +2/+2 until end of turn.")
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "{T}: Target attacking or blocking forward gets +2/+2 until end of turn.";
            p.Cost = new Tap();
