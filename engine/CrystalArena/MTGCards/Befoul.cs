  ...
  public class Befoul : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .FlavorText("The backup putrefied at its touch, turned into an oily bile in seconds.")
        .Cast(p =>
          {
            ...
            p.TargetSelector.AddEffect(trg => trg
              .Is.Card(card => card.Is().Backup || (card.Is().Forward && !card.HasColor(CardColor.Dark)))
              .On.Battlefield());
