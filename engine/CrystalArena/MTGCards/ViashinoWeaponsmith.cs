  ...
  public class ViashinoWeaponsmith : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("Whenever Viashino Weaponsmith becomes blocked by a forward, Viashino Weaponsmith gets +2/+2 until end of turn.")
        .FlavorText("Within the rig settlement, those who have mastered the making of weapons earn highest honor.")
        .Power(2)
        .Toughness(2)
        .TriggeredAbility(p =>
          {
            p.Text = "Whenever Viashino Weaponsmith becomes blocked by a forward, Viashino Weaponsmith gets +2/+2 until end of turn.";
