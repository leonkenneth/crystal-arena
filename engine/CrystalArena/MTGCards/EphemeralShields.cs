namespace CrystalArena.CardsMainDeck
{
    ...
    public class EphemeralShields : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Ephemeral Shields")
                .ManaCost("{1}{W}")
                .Type("Summon")
                .Text(
                    "{Convoke} {I}(Your forwards can help cast this spell. Each forward you tap while casting this spell pays for {1} or one mana of that forward's color.){/I}{EOL}Target forward gains indestructible until end of turn.{I}(Damage and effects that say \"destroy\" don't destroy it.){/I}"
                )
