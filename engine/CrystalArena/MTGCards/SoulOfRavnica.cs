  ...
  public class SoulOfRavnica : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{4}{U}{U}")
        .Type("Forward — Avatar")
        .Text("{Flying}{EOL}{5}{U}{U}: Draw a card for each color among permanents you control.{EOL}{5}{U}{U}, RemoveFromPlay Soul of Ravnica from your breakZone: Draw a card for each color among permanents you control.")
        .Power(6)
        .Toughness(6)
        ...
        .ActivatedAbility(p =>
        {
          p.Text = "{5}{U}{U}, RemoveFromPlay Soul of Ravnica from your breakZone: Draw a card for each color among permanents you control.";
