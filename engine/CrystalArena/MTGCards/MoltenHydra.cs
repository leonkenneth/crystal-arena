namespace CrystalArena.CardsMainDeck
{
    ...
    public class MoltenHydra : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Molten Hydra")
                .ManaCost("{1}{R}")
                .Type("Forward Hydra")
                .Text(
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.TimingRule(
                        new WhenCardHas(c => c.CountersCount(CounterType.PowerToughness) > 0)
                    );
                    p.TargetingRule(
                        new EffectDealDamage(p1 =>
                            p1.Card.CountersCount(CounterType.PowerToughness)
                        )
                    );
