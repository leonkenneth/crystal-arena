namespace CrystalArena.CardsMainDeck
{
    ...
    public class Disappear : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Disappear")
                .ManaCost("{2}{U}{U}")
                .Type("Monster Aura")
                .Text("{U}: Return enchanted forward and Disappear to their owners' hands.")
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.Text = "{U}: Return enchanted forward and Disappear to their owners' hands.";
