  ...
  public class SealOfFire : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{R}")
        .Type("Monster")
        .Text("Sacrifice Seal of Fire: Seal of Fire deals 2 damage to target forward or player.")
        .FlavorText("I am the romancer, the passion that consumes the flesh.")
        .ActivatedAbility(p =>
          {
            p.Text = "Sacrifice Seal of Fire: Seal of Fire deals 2 damage to target forward or player.";
