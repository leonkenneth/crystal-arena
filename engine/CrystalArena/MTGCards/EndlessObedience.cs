  ...
  public class EndlessObedience : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{4}{B}{B}")
        .Type("Sorcery")
        .Text("{Convoke} {I}(Your forwards can help cast this spell. Each forward you tap while casting this spell pays for {1} or one mana of that forward's color.){/I}{EOL}Put target forward card from a breakZone onto the battlefield under your control.")
        .FlavorText("The death of a scout can be as informative as a safe return.")
        .SimpleAbilities(Static.Convoke)
        .Cast(p =>
        {
          p.Text = "Put target forward card from a breakZone onto the battlefield under your control.";
