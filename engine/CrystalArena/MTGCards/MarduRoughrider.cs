namespace CrystalArena.CardsMainDeck
{
    ...
    public class MarduRoughrider : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Mardu Roughrider")
                .ManaCost("{2}{R}{W}{B}")
                .Type("Forward — Orc Warrior")
                .Text("Whenever Mardu Roughrider attacks, target forward can't block this turn.")
                .FlavorText(
                ...
                {
                    p.Text =
                        "Whenever Mardu Roughrider attacks, target forward can't block this turn.";
