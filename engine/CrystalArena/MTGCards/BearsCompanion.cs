namespace CrystalArena.CardsMainDeck
{
    ...
    public class BearsCompanion : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Bear's Companion")
                .ManaCost("{2}{G}{U}{R}")
                .Type("Forward - Human Warrior")
                .Text(
                    "When Bear's Companion enters the battlefield, put a 4/4 wind Bear forward token onto the battlefield."
                )
                .FlavorText(
