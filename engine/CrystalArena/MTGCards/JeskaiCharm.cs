  ...
  public class JeskaiCharm : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{U}{R}{W}")
        .Type("Summon")
        .Text("Choose one —{EOL}• Put target forward on top of its owner's library.{EOL}• Jeskai Charm deals 4 damage to target opponent.{EOL}• Forwards you control get +1/+1 and gain lifelink until end of turn.")
        .Cast(p =>
        {
        ...
        .Cast(p =>
        {
          p.Text = "{{U}}{{R}}{{W}}: Forwards you control get +1/+1 and gain lifelink until end of turn.";
