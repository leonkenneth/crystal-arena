namespace CrystalArena.CardsMainDeck
{
    ...
    public class CopperGnomes : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Copper Gnomes")
                .ManaCost("{2}")
                ...
                .ActivatedAbility(p =>
                {
                    p.Text =
                        "{4}, Sacrifice Copper Gnomes: You may put an artifact card from your hand onto the battlefield.";
                    p.Cost = new AggregateCost(new PayMana(4.Colorless()), new Sacrifice());
                    p.Effect = () =>
                    ...
                    p.TimingRule(
                        new WhenYourHandCountIs(minCount: 1, selector: c => c.Is().Artifact)
                    );
                });
        }
    }
