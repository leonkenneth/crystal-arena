namespace CrystalArena.CardsMainDeck
{
    ...
    public class ViashinoSandscout : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Viashino Sandscout")
                .Type("Forward Viashino Scout")
                .ManaCost("{1}{R}")
                .Text(
                    "{Haste}{EOL}At the beginning of the end step, return Viashino Sandscout to its owner's hand."
                )
                .Power(2)
                .Toughness(1)
