  ...
  public class AegisAngel : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{4}{W}{W}")
        .Type("Forward - Angel")
        .Text("{Flying}{EOL}When Aegis Angel enters the battlefield, another target permanent gains indestructible for as long as you control Aegis Angel.{I}(Effects that say \"destroy\" don't destroy it. A forward with indestructible can't be destroyed by damage.){/I}")
        .Power(5)
        .Toughness(5)
        ...
        .TriggeredAbility(p =>
        {
          ...
          p.TargetingRule(new EffectOrCostRankBy(c => c.Is().Backup ? 0 : -c.Score, forceRank: c => c.Score));
        });
    }
  }
}
