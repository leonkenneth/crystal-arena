namespace CrystalArena.CardsMainDeck
{
    ...
    public class ShieldOfTheAvatar : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Shield of the Avatar")
                .ManaCost("{1}")
                .Type("Artifact — Equipment")
                .Text(
                    "If a source would deal damage to equipped forward, prevent X of that damage, where X is the number of forwards you control.{EOL}Equip {2}({2}: Attach to target forward you control. Equip only as a sorcery.)"
                )
