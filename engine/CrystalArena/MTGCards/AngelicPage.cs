  ...
  public class AngelicPage : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Flying}{EOL}{T}: Target attacking or blocking forward gets +1/+1 until end of turn.")
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "{T}: Target attacking or blocking forward gets +1/+1 until end of turn.";
            p.Cost = new Tap();
