namespace CrystalArena.CardsMainDeck
{
    ...
    public class AngelicPage : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Angelic Page")
                .ManaCost("{1}{W}")
                .Type("Forward Angel Spirit")
                .Text(
                    "{Flying}{EOL}{T}: Target attacking or blocking forward gets +1/+1 until end of turn."
                )
                ...
                {
                    p.Text =
                        "{T}: Target attacking or blocking forward gets +1/+1 until end of turn.";
                    p.Cost = new Tap();
                    p.Effect = () =>
