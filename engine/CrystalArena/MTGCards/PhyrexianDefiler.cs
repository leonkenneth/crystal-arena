  ...
  public class PhyrexianDefiler : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{T}, Sacrifice Phyrexian Defiler: Target forward gets -3/-3 until end of turn.")
        .FlavorText("The third stage of the illness: muscle aches and persistent cough.")
        .Power(3)
        .Toughness(3)
        .ActivatedAbility(p =>
          {
            p.Text = "{T}, Sacrifice Phyrexian Defiler: Target forward gets -3/-3 until end of turn.";
