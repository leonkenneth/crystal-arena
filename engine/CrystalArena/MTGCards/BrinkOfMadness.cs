namespace CrystalArena.CardsMainDeck
{
    ...
    public class BrinkOfMadness : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Brink of Madness")
                .ManaCost("{2}{B}{B}")
                .Type("Monster")
                .Text(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnStepStart(activeTurn: true, passiveTurn: false, step: Step.Upkeep)
                        {
                    ...
                    p.Effect = () =>
                        new CompoundEffect(new SacrificeOwner(), new OpponentDiscardsHand());
                });
        }
    }
}
