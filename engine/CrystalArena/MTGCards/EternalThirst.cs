  ...
  public class EternalThirst : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{1}{B}")
        .Type("Monster — Aura")
        .Text("Enchant forward{EOL}Enchanted forward has lifelink and \"Whenever a forward an opponent controls dies, put a +1/+1 counter on this forward.\" {I}(Damage dealt by a forward with lifelink also causes its controller to gain that much life.){/I}")
        .Cast(p =>
        {
          p.Effect = () => new Attach(
            ...
            () =>
            {
              ...
              {
                Text = "Whenever a forward an opponent controls dies, put a +1/+1 counter on this forward.",
