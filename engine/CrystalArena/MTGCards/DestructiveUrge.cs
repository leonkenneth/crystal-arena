namespace CrystalArena.CardsMainDeck
{
    ...
    public class DestructiveUrge : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Destructive Urge")
                .ManaCost("{1}{R}{R}")
                .Type("Monster Aura")
                .Text(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnDamageDealt(dmg =>
                            dmg.IsDealtToPlayer && dmg.IsCombat && dmg.IsDealtByEnchantedForward
                        )
                    );
                    ...
                    p.Effect = () =>
                        new PlayersSacrificePermanents(
                            ...
                            playerFilter: (e, player) =>
                                e.TriggerMessage<DamageDealtEvent>().Receiver == player
                        );
