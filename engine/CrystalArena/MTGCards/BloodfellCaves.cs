namespace CrystalArena.CardsMainDeck
{
    ...
    public class BloodfellCaves : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Bloodfell Caves")
                .Type("Backup")
                .Text(
                    "Bloodfell Caves enters the battlefield tapped.{EOL}When Bloodfell Caves enters the battlefield, you gain 1 life.{EOL}{T}: Add {B} or {R} to your mana pool."
                )
