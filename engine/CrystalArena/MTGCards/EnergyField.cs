namespace CrystalArena.CardsMainDeck
{
    ...
    public class EnergyField : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Energy Field")
                .ManaCost("{1}{U}")
                .Type("Monster")
                .Text(
                ...
                .StaticAbility(p =>
                    p.Modifier(() =>
                        new AddDamagePrevention(modifier => new PreventDamageToTarget(
                            ...
                            sourceSelector: (card, ctx) =>
                                card.Controller != modifier.SourceCard.Controller
                        ))
                    )
                )
                .TriggeredAbility(p =>
                {
                    p.Text =
                        "When a card is put into your breakZone from anywhere, sacrifice Energy Field.";
