  ...
  public class PhyrexianReclamation : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{B}")
        .Type("Monster")
        .Text("{1}{B}, Pay 2 life: Return target forward card from your breakZone to your hand.")
        .FlavorText("Death is no excuse to stop working.")
        .Cast(p => p.TimingRule(new OnFirstMain()))
        .ActivatedAbility(p =>
          {
            p.Text = "{1}{B}, Pay 2 life: Return target forward card from your breakZone to your hand.";
