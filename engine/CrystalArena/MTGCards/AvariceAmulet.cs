  ...
  public class AvariceAmulet : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("Equipped forward gets +2/+0 and has brave and \"At the beginning of your upkeep, draw a card.\"{EOL}When equipped forward dies, target opponent gains control of Avarice Amulet.{EOL}Equip {2} ({2}: Attach to target forward you control. Equip only as a sorcery.)")
        .FlavorText("")
        .ActivatedAbility(p =>
        {
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "When equipped forward dies, target opponent gains control of Avarice Amulet.";
