  ...
  public class TragicPoet : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{W}")
        .Type("Forward Human")
        .Text("{T}, Sacrifice Tragic Poet: Return target monster card from your breakZone to your hand.")
        .FlavorText(
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "{T}, Sacrifice Tragic Poet: Return target monster card from your breakZone to your hand.";
            ...
            p.TimingRule(new Any(new OnFirstMain(), new OnOpponentsTurn(Step.DeclareBlocker)));
