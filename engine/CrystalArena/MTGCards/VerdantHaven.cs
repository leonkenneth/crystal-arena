namespace CrystalArena.CardsMainDeck
{
    ...
    public class VerdantHaven : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Verdant Haven")
                .ManaCost("{2}{G}")
                .Type("Monster — Aura")
                .Text(
                    "Enchant backup{EOL}When Verdant Haven enters the battlefield, you gain 2 life.{EOL}Whenever enchanted backup is tapped for mana, its controller adds one mana of any color to his or her mana pool {I}(in addition to the mana the backup produces).{/I}"
                )
                .Cast(p =>
                {
