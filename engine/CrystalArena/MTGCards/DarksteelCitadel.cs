namespace CrystalArena.CardsMainDeck
{
    ...
    public class DarksteelCitadel : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Darksteel Citadel")
                .Type("Artifact Backup")
                .Text(
                    "Indestructible (Effects that say \"destroy\" don't destroy this backup.){EOL}{T}: Add {1} to your mana pool."
                )
