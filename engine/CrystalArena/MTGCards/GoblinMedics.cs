  ...
  public class GoblinMedics : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("Whenever Goblin Medics becomes tapped, it deals 1 damage to target forward or player.")
        .FlavorText("First, do some harm.")
        .Power(1)
        .Toughness(1)
        .TriggeredAbility(p =>
          {
            p.Text = "Whenever Goblin Medics becomes tapped, it deals 1 damage to target forward or player.";
