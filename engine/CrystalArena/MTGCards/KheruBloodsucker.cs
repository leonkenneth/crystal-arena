namespace CrystalArena.CardsMainDeck
{
    ...
    public class KheruBloodsucker : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Kheru Bloodsucker")
                .ManaCost("{2}{B}")
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnZoneChanged(
                            ...
                            to: Zone.BreakZone,
                            selector: (c, ctx) =>
                                c.Controller == ctx.You && c.Is().Forward && c.Toughness >= 4
                        )
                    );
                ...
                {
                    p.Text =
                        "{2}{B}, Sacrifice another forward: Put a +1/+1 counter on Kheru Bloodsucker.";

                    p.Cost = new AggregateCost(new PayMana("{2}{B}".Parse()), new Sacrifice());
