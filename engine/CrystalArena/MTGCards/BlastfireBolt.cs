  ...
  public class BlastfireBolt : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{5}{R}")
        .Type("Summon")
        .Text("Blastfire Bolt deals 5 damage to target forward. Destroy all Equipment attached to that forward.")
        .FlavorText(
        ...
        .Cast(p =>
          {
            p.Effect = () => new CompoundEffect(
              ...
              new DestroyAttachedAttachments(P(e => e.Target.Card().Cards), (c, ctx) => c.Is().Equipment));
