namespace CrystalArena.CardsMainDeck
{
    ...
    public class RoguesGloves : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rogue's Gloves")
                .ManaCost("{2}")
                .Type("Artifact — Equipment")
                .Text(
                    "Whenever equipped forward deals combat damage to a player, you may draw a card.{EOL}{Equip}{2} {I}({2}: Attach to target forward you control. Equip only as a sorcery.){/I}"
                )
                ...
                {
                    p.Text =
                        "Whenever equipped forward deals combat damage to a player, you may draw a card.";
