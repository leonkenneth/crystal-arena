namespace CrystalArena.CardsMainDeck
{
    ...
    public class Anthroplasm : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Anthroplasm")
                .ManaCost("{2}{U}{U}")
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Effect = () =>
                        new ApplyModifiersToSelf(() =>
                            new AddCounters(() => new PowerToughness(1, 1), 2)
                        );
                    p.UsesStack = false;
                })
                .ActivatedAbility(p =>
                {
                    ...
                    p.Effect = () =>
                        new CompoundEffect(
                            ...
                            new ApplyModifiersToSelf(() =>
                                new AddCounters(() => new PowerToughness(1, 1), Value.PlusX)
                            )
                        );
                    ...
                    p.TimingRule(
                        new Any(
                            new PumpOwningCardTimingRule(Value.PlusX, Value.PlusX),
