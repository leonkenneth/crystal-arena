  ...
  public class RangersGuile : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{G}")
        .Type("Summon")
        .Text("Target forward you control gets +1/+1 and gains hexproof until end of turn. {I}(It can't be the target of spells or abilities your opponents control.){/I}")
