  ...
  public class UndergrowthScavenger : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("Undergrowth Scavenger enters the battlefield with a number of +1/+1 counters on it equal to the number of forward cards in all breakZones.")
        ...
        .TriggeredAbility(p =>
        {
          ...
          p.Effect = () => new ApplyModifiersToSelf(() => new AddCounters(
           ...
           count: ctx => ctx.Players.Player1.BreakZone.Forwards.Count() + ctx.Players.Player2.BreakZone.Forwards.Count()));
