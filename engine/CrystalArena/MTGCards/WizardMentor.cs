  ...
  public class WizardMentor : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{T}: Return Wizard Mentor and target forward you control to their owner's hand.")
        .FlavorText(
        ...
        .ActivatedAbility(p =>
          {
            p.Text = "{T}: Return Wizard Mentor and target forward you control to their owner's hand.";
            p.Cost = new Tap();
