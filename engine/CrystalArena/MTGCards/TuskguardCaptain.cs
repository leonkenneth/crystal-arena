namespace CrystalArena.CardsMainDeck
{
    ...
    public class TuskguardCaptain : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Tuskguard Captain")
                .ManaCost("{2}{G}")
                .Type("Forward - Human Warrior")
                .Text(
                    "Outlast {G}{I}({G}, {T}: Put a +1/+1 counter on this forward. Outlast only as a sorcery.){/I}{EOL}Each forward you control with a +1/+1 counter on it has trample."
                )
