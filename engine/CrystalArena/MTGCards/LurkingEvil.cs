  ...
  public class LurkingEvil : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{B}{B}{B}")
        .Type("Monster")
        .Text("Pay half your life, rounded up: Lurking Evil becomes a 4/4 Horror forward with flying.")
        .FlavorText("Ash is our air, darkness our flesh.")
        .Cast(p => p.TimingRule(new OnSecondMain()))
        .ActivatedAbility(p =>
          {
            p.Text = "Pay half your life, rounded up: Lurking Evil becomes a 4/4 Horror forward with flying.";
