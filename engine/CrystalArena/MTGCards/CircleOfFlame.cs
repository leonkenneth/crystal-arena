namespace CrystalArena.CardsMainDeck
{
    ...
    public class CircleOfFlame : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Circle of Flame")
                .ManaCost("{1}{R}")
                .Type("Monster")
                .Text(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new WhenAForwardAttacks(t => t.You && t.AttackerHas(c => !c.Has().Flying))
                    );
                    ...
                    p.Effect = () =>
                        new DealDamageToForward(
                            amount: 1,
                            forward: P(e =>
                                e.TriggerMessage<AttackerJoinedCombatEvent>().Attacker.Card
                            )
                        );
