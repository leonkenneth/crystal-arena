  ...
  public class BattleBrawler : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("As long as you control a fire or light permanent, Battle Brawler gets +1/+0 and has first strike.")
        ...
        .StaticAbility(p =>
        {
          ...
          p.Condition = cond => cond.OwnerControlsPermanent(c => c.HasColor(CardColor.Fire) || c.HasColor(CardColor.Light));
        });
    }
  }
}
