namespace CrystalArena.CardsMainDeck
{
    ...
    public class EnsoulArtifact : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Ensoul Artifact")
                .ManaCost("{1}{U}")
                .Type("Monster — Aura")
                .Text(
                    "Enchant artifact{EOL}Enchanted artifact is a forward with base power and toughness 5/5 in addition to its other types."
                )
                .FlavorText(
