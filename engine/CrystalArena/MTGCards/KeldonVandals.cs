namespace CrystalArena.CardsMainDeck
{
    ...
    public class KeldonVandals : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Keldon Vandals")
                .ManaCost("{2}{R}")
                .Type("Forward Human Rogue")
                .Text(
                    "{Echo} {2}{R}{EOL}When Keldon Vandals enters the battlefield, destroy target artifact."
                )
                .FlavorText(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.TargetSelector.AddEffect(trg =>
                        trg.Is.Card(card => card.Is().Artifact).On.Battlefield()
                    );
