namespace CrystalArena.CardsMainDeck
{
    ...
    public class CleverImpersonator : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Clever Impersonator")
                .ManaCost("{2}{U}{U}")
                ...
                .FlavorText(
                    "\"Our own selves are the greatest obstacles to enlightenment.\"{EOL}—Narset, khan of the Jeskai"
                )
                .Power(0)
                .Toughness(0)
                .Cast(p => p.TimingRule(new WhenPermanentCountIs(1, c => !c.Is().Backup)))
                .TriggeredAbility(p =>
                {
                    p.Text =
                        "You may have Clever Impersonator enter the battlefield as a copy of any nonland permanent on the battlefield.";
                    ...
                    p.TargetSelector.AddEffect(
                        trg =>
                            trg.Is.Card(c => !c.Is().Backup, controlledBy: ControlledBy.Any)
                                .On.Battlefield(),
