namespace CrystalArena.CardsMainDeck
{
    ...
    public class Masticore : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Masticore")
                .ManaCost("{4}")
                .Type("Artifact Forward Masticore")
                .Text(
                    "At the beginning of your upkeep, sacrifice Masticore unless you discard a card.{EOL}{2}: Masticore deals 1 damage to target forward.{EOL}{2}: Regenerate Masticore."
                )
                .Power(4)
                .Toughness(4)
                .TriggeredAbility(p =>
                ...
                .ActivatedAbility(p =>
                {
                    p.Text = "{2}: Masticore deals 1 damage to target forward.";
