  ...
  public class Hammerhand : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{R}")
        .Type("Monster — Aura")
        .Text("Enchant forward{EOL}When Hammerhand enters the battlefield, target forward can't block this turn.{EOL}Enchanted forward gets +1/+1 and has haste. {I}(It can attack and no matter when it came under your control.){/I}")
        .Cast(p =>
        {
          p.Effect = () => new Attach(
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "When Hammerhand enters the battlefield, target forward can't block this turn.";
