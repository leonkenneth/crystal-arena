  ...
  public class WarNameAspirant : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{I}Raid{/I} — War-Name Aspirant enters the battlefield with a +1/+1 counter on it if you attacked with a forward this turn.{EOL}War-Name Aspirant can't be blocked by forwards with power 1 or less.")
        ...
        .TriggeredAbility(p =>
        {
          p.Text = "War-Name Aspirant enters the battlefield with a +1/+1 counter on it if you attacked with a forward this turn.";
