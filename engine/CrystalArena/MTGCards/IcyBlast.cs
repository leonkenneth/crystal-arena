  ...
  public class IcyBlast : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Type("Summon")
        .Text("Tap X target forwards.{EOL}{I}Ferocious{/I} — If you control a forward with power 4 or greater, those forwards don't untap during their controllers' next untap steps.")
