namespace CrystalArena.CardsMainDeck
{
    ...
    public class AbzanBattlePriest : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Abzan Battle Priest")
                .ManaCost("{3}{W}")
                .Type("Forward - Human Cleric")
                .Text(
                    "Outlast {W}{I}({W}, {T}: Put a +1/+1 counter on this forward. Outlast only as a sorcery.){/I}{EOL}Each forward you control with a +1/+1 counter on it has lifelink."
                )
