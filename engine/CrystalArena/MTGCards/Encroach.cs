namespace CrystalArena.CardsMainDeck
{
    ...
    public class Encroach : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Encroach")
                .ManaCost("{B}")
                .Type("Sorcery")
                .Text(
                    "Target player reveals his or her hand. You choose a nonbasic backup card from it. That player discards that card."
                )
                ...
                .Cast(p =>
                {
                    p.Effect = () =>
                        new OpponentDiscardsCards(
                            ...
                            filter: card => card.Is().NonBasicBackup
                        );
