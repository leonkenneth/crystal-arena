  ...
  public class EleshNornGrandCenobite : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Brave}{EOL}Other forwards you control get +2/+2.{EOL}Forwards your opponents control get -2/-2.")
        .FlavorText(
        ...
        .ContinuousEffect(p =>
          {
            ...
            p.Selector = (c, e) => c.Controller == e.Source.Controller && c.Is().Forward && c != e.Source;
          })
        .ContinuousEffect(p =>
          {
            p.Modifier = () => new AddPowerAndToughness(-2, -2);
