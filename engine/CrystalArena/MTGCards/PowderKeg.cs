namespace CrystalArena.CardsMainDeck
{
    ...
    public class PowderKeg : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Powder Keg")
                .ManaCost("{2}")
                .Type("Artifact")
                .Text(
                    "At the beginning of your upkeep, you may put a fuse counter on Powder Keg.{EOL}{T}, Sacrifice Powder Keg: Destroy each artifact and forward with converted mana cost equal to the number of fuse counters on Powder Keg."
                )
                ...
                {
                    p.Text =
                        "{T}, Sacrifice Powder Keg: Destroy each artifact and forward with converted mana cost equal to the number of fuse counters on Powder Keg.";
