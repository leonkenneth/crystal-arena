namespace CrystalArena.CardsMainDeck
{
    ...
    public class RofellossGift : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rofellos's Gift")
                .ManaCost("{G}")
                .Type("Sorcery")
                .Text(
                ...
                {
                    p.Effect = () =>
                        new ReturnCardsFromBreakZoneToHandForEachRevealedCard(
                    ...
                    p.TimingRule(
                        new WhenYourBreakZoneCountIs(minCount: 1, selector: c => c.Is().Monster)
                    );
                });
        }
    }
