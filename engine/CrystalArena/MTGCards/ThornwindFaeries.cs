namespace CrystalArena.CardsMainDeck
{
    ...
    public class ThornwindFaeries : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Thornwind Faeries")
                .ManaCost("{1}{U}{U}")
                .Type("Forward Faerie")
                .Text(
                    "{Flying}{EOL}{T}: Thornwind Faeries deals 1 damage to target forward or player."
                )
                .FlavorText(
                ...
                .ActivatedAbility(p =>
                {
                    p.Text = "{T}: Thornwind Faeries deals 1 damage to target forward or player.";
                    p.Cost = new Tap();
