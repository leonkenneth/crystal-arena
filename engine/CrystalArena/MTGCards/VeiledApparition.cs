namespace CrystalArena.CardsMainDeck
{
    ...
    public class VeiledApparition : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Veiled Apparition")
                .ManaCost("{1}{U}")
                .Type("Monster")
                .Text(
                    ...
                    p.Effect = () =>
                        new ApplyModifiersToSelf(
                            ...
                            () =>
                            {
                                ...
                                tp.Text =
                                    "At the beginning of your upkeep, sacrifice Veiled Apparition unless you pay {1}{U}.";
                                ...
                                tp.Effect = () =>
                                    new PayManaThen(
                                        ...
                                        parameters: new PayThen.Parameters()
                                        {
                                            ExecuteIfPaid = false,
                                            Message =
                                                "Pay upkeep? (or sacrifice Veiled Apparition)",
                                        }
                                    );
