namespace CrystalArena.CardsMainDeck
{
    ...
    public class AetherSting : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Aether Sting")
                .ManaCost("{3}{R}")
                .Type("Monster")
                .Text(
                    "Whenever an opponent casts a forward spell, Aether Sting deals 1 damage to that player."
                )
                .FlavorText(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnCastedSpell(
                            (c, ctx) => ctx.Opponent == c.Controller && c.Is().Forward
                        )
                    );
