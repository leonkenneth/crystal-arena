namespace CrystalArena.CardsMainDeck
{
    ...
    public class WindScarredCrag : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Wind-Scarred Crag")
                .Type("Backup")
                .Text(
                    "Wind-Scarred Crag enters the battlefield tapped.{EOL}When Wind-Scarred Crag enters the battlefield, you gain 1 life.{EOL}{T}: Add {R} or {W} to your mana pool."
                )
