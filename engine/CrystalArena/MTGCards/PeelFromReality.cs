  ...
  public class PeelFromReality : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{1}{U}")
        .Type("Summon")
        .Text("Return target forward you control and target forward you don't control to their owners' hands.")
        .FlavorText("\"Soulless demon, you are bound to me. Now we will both dwell in oblivion.\"")
        .Cast(p =>
          {
            p.Text = "Return target forward you control and target forward you don't control to their owners' hands.";
