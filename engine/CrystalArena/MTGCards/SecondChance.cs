namespace CrystalArena.CardsMainDeck
{
    ...
    public class SecondChance : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Second Chance")
                .ManaCost("{2}{U}")
                .Type("Monster")
                .Text(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnStepStart(step: Step.Upkeep) { Condition = ctx => ctx.You.Life <= 5 }
                    );

                    p.Effect = () => new CompoundEffect(new SacrificeOwner(), new TakeExtraTurn());
