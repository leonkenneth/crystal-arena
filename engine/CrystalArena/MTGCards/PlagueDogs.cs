namespace CrystalArena.CardsMainDeck
{
    ...
    public class PlagueDogs : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Plague Dogs")
                .ManaCost("{4}{B}")
                .Type("Forward Zombie Hound")
                .Text(
                    "When Plague Dogs dies, all forwards get -1/-1 until end of turn.{EOL}{2}, Sacrifice Plague Dogs: Draw a card."
                )
                ...
                .TriggeredAbility(p =>
                {
                    p.Text = "When Plague Dogs dies, all forwards get -1/-1 until end of turn.";
