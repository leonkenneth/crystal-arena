namespace CrystalArena.CardsMainDeck
{
    ...
    public class Opposition : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Opposition")
                .ManaCost("{2}{U}{U}")
                .Type("Monster")
                .Text(
                    "Tap an untapped forward you control: Tap target artifact, forward, or backup."
                )
                .FlavorText(
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.TargetSelector.AddCost(
                            ...
                            trg =>
                            {
                                trg.Message = "Select a forward you control.";
                            }
                        )
                        .AddEffect(
                            trg =>
                                trg.Is.Card(c => c.Is().Forward || c.Is().Artifact || c.Is().Backup)
                                    .On.Battlefield(),
                            trg =>
                            {
                                trg.Message = "Select an artifact, forward or backup.";
                            }
                        );
