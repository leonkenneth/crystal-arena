namespace CrystalArena.CardsMainDeck
{
    ...
    public class Exhaustion : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Exhaustion")
                .ManaCost("{2}{U}")
                .Type("Sorcery")
                .Text(
                    "Forwards and backups target opponent controls don't untap during his or her next untap step."
                )
                .FlavorText(
                            ...
                            modifiers: () =>
                            {
                                var cp = new ContinuousEffectParameters
                                {
                                    Selector = (card, ctx) =>
                                        ...
                                        && (card.Is().Forward || card.Is().Backup),
