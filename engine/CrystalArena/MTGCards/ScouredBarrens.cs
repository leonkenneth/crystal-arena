namespace CrystalArena.CardsMainDeck
{
    ...
    public class ScouredBarrens : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Scoured Barrens")
                .Type("Backup")
                .Text(
                    "Scoured Barrens enters the battlefield tapped.{EOL}When Scoured Barrens enters the battlefield, you gain 1 life.{EOL}{T}: Add {W} or {B} to your mana pool."
                )
