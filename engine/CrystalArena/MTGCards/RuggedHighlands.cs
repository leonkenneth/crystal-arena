namespace CrystalArena.CardsMainDeck
{
    ...
    public class RuggedHighlands : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rugged Highlands")
                .Type("Backup")
                .Text(
                    "Rugged Highlands enters the battlefield tapped.{EOL}When Rugged Highlands enters the battlefield, you gain 1 life.{EOL}{T}: Add {R} or {G} to your mana pool."
                )
