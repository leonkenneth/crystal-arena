namespace CrystalArena.CardsMainDeck
{
    ...
    public class BribersPurse : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Briber's Purse")
                .ManaCost("{0}")
                .HasXInCost()
                .Type("Artifact")
                .Text(
                    "Briber's Purse enters the battlefield with X gem counters on it.{EOL}{1},{T}, Remove a gem counter from Briber's Purse: Target forward can't attack or block this turn."
                )
                ...
                .Cast(p =>
                {
                    ...
                    p.AfterResolve = (c, ctx) =>
                    {
                        ...
                        var addCounters = new AddCounters(
                            () => new SimpleCounter(CounterType.Gem),
                            Value.PlusX
                        );
                ...
                {
                    p.Text =
                        "{1},{T}, Remove a gem counter from Briber's Purse: Target forward can't attack or block this turn.";
                    ...
                    p.Effect = () =>
                        new ApplyModifiersToTargets(
                            ...
                            () => new AddSimpleAbility(Static.CannotAttack) { UntilEot = true }
