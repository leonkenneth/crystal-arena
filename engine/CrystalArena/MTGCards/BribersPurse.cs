  ...
  public class BribersPurse : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Type("Artifact")
        .Text("Briber's Purse enters the battlefield with X gem counters on it.{EOL}{1},{T}, Remove a gem counter from Briber's Purse: Target forward can't attack or block this turn.")
        ...
        .ActivatedAbility(p =>
        {
          p.Text = "{1},{T}, Remove a gem counter from Briber's Purse: Target forward can't attack or block this turn.";
