  ...
  public class ArrowStorm : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{3}{R}{R}")
        .Type("Sorcery")
        .Text("Arrow Storm deals 4 damage to target forward or player.{EOL}{I}Raid{/I} — If you attacked with a forward this turn, instead Arrow Storm deals 5 damage to that forward or player and the damage can't be prevented.")
        .Cast(p =>
        {
