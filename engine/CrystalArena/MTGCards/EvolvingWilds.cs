namespace CrystalArena.CardsMainDeck
{
    ...
    public class EvolvingWilds : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Evolving Wilds")
                .Type("Backup")
                .Text(
                    "{T}, Sacrifice Evolving Wilds: Search your library for a basic backup card and put it onto the battlefield tapped. Then shuffle your library."
                )
                .FlavorText(
