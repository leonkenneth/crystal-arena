namespace CrystalArena.CardsMainDeck
{
    ...
    public class MemoryJar : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Memory Jar")
                .ManaCost("{5}")
                .Type("Artifact")
                .Text(
                    "{T}, Sacrifice Memory Jar: Each player exiles all cards from his or her hand face down and draws seven cards. At the beginning of the next end step, each player discards his or her hand and returns to his or her hand each card he or she removedFromPlay this way."
                )
