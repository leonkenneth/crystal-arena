  ...
  public class FleecemaneLion : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{G}{W}")
        .Type("Forward — Cat")
        .Text("{3}{G}{W}: Monstrosity 1.{I}(If this forward isn't monstrous, put a +1/+1 counter on it and it becomes monstrous.){/I}{EOL}As long as Fleecemane Lion is monstrous, it has hexproof and indestructible.")
        .Power(3)
        .Toughness(3)
        .StaticAbility(p =>
        {
        ...
        .ActivatedAbility(p =>
        {
          p.Text = "{3}{G}{W}: Monstrosity 1.{I}(If this forward isn't monstrous, put a +1/+1 counter on it and it becomes monstrous.){/I}";
