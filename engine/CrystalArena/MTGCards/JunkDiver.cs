  ...
  public class JunkDiver : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Flying}{EOL}When Junk Diver dies, return another target artifact card from your breakZone to your hand.")
        ...
        .TriggeredAbility(p =>
          {
            p.Text = "When Junk Diver dies, return another target artifact card from your breakZone to your hand.";
