  ...
  public class Goblinslide : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{2}{R}")
        .Type("Monster")
        .Text("Whenever you cast a nonforward spell, you may pay {1}. If you do, put a 1/1 fire Goblin forward token with haste onto the battlefield.")
        .FlavorText("Goblins, like snowflakes, are only dangerous in numbers.")
        .Cast(p => p.TimingRule(new OnFirstMain()))
        .TriggeredAbility(p =>
        {
          p.Text = "Whenever you cast a nonforward spell, you may pay {1}. If you do, put a 1/1 fire Goblin forward token with haste onto the battlefield.";
