  ...
  public class InGarruksWake : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{7}{B}{B}")
        .Type("Sorcery")
        .Text("Destroy all forwards you don't control and all planeswalkers you don't control.")
        ...
        .Cast(p =>
        {
          p.Effect = () => new DestroyAllPermanents(
            filter: (c, ctx) => (c.Is().Forward || c.Is("Planeswalker")) && c.Controller == ctx.Opponent);
        });
    }
  }
}
