namespace CrystalArena.CardsMainDeck
{
    ...
    public class AjaniSteadfast : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Ajani Steadfast")
                .ManaCost("{3}{W}")
                .Type("Planeswalker Ajani")
                .Text(
                    "{+1}: Until end of turn, up to one target forward gets +1/+1 and gains first strike, brave, and lifelink.{EOL}"
                        + "{-2}: Put a +1/+1 counter on each forward you control and a loyalty counter on each other planeswalker you control.{EOL}"
                ...
                {
                    p.Text =
                        "{+1}: Until end of turn, up to one target forward gets +1/+1 and gains first strike, brave, and lifelink.";
                    ...
                    p.Effect = () =>
                        new ApplyModifiersToTargets(
                            ...
                            () => new AddSimpleAbility(Static.Brave) { UntilEot = true },
                    ...
                    p.Effect = () =>
                        new CompoundEffect(
                            ...
                            new ApplyModifiersToPermanents(
                                ...
                                modifier: () =>
                                    new AddCounters(
                                        () => new SimpleCounter(CounterType.Loyality),
                                        1
                                    )
                            )
                        );
                        ...
                        new CreateEmblem(
                            ...
                            modifiers: () =>
                                new AddDamagePrevention(
                                    new PreventDamageToPermanentsOrPlayers(
