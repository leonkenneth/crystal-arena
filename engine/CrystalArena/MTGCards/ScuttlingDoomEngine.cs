namespace CrystalArena.CardsMainDeck
{
    ...
    public class ScuttlingDoomEngine : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Scuttling Doom Engine")
                .ManaCost("{6}")
                .Type("Artifact Forward — Construct")
                .Text(
                    "Scuttling Doom Engine can't be blocked by forwards with power 2 or less.{EOL}When Scuttling Doom Engine dies, it deals 6 damage to target opponent."
                )
