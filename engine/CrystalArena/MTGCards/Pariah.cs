namespace CrystalArena.CardsMainDeck
{
    ...
    public class Pariah : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Pariah")
                .ManaCost("{2}{W}")
                .Type("Monster - Aura")
                .Text(
                    "All damage that would be dealt to you is dealt to enchanted forward instead."
                )
                .FlavorText(
                ...
                .Cast(p =>
                {
                    ...
                    p.TargetingRule(new EffectRedirectDamageToForwardMonster());
                });
        }
    }
}
