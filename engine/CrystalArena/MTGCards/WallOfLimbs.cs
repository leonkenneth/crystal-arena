namespace CrystalArena.CardsMainDeck
{
    ...
    public class WallOfLimbs : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Wall of Limbs")
                .ManaCost("{2}{B}")
                .Type("Forward - Zombie Wall")
                .Text(
                    "{Defender}{I}(This forward can't attack.){/I}{EOL}Whenever you gain life, put a +1/+1 counter on Wall of Limbs.{EOL}{5}{B}{B},Sacrifice Wall of Limbs: Target player loses X life, where X is Wall of Limbs's power."
                )
                .FlavorText(
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.Cost = new AggregateCost(new PayMana("{5}{B}{B}".Parse()), new Sacrifice());
