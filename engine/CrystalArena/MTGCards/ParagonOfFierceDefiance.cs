namespace CrystalArena.CardsMainDeck
{
    ...
    public class ParagonOfFierceDefiance : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Paragon of Fierce Defiance")
                .ManaCost("{3}{R}")
                ...
                {
                    p.Text =
                        "{R},{T}: Another target fire forward you control gains haste until end of turn.";
                    ...
                    p.TargetSelector.AddEffect(trg =>
                        trg.Is.Card(
                                c => c.Is().Forward && c.HasColor(CardColor.Fire),
