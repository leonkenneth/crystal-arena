  ...
  public class InfernoFist : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{1}{R}")
        .Type("Monster — Aura")
        .Text("Enchant forward you control{EOL}Enchanted forward gets +2/+0.{EOL}{R}, Sacrifice Inferno Fist: Inferno Fist deals 2 damage to target forward or player.")
        .Cast(p =>
        {
          p.Effect = () => new Attach(
        ...
        .ActivatedAbility(p =>
        {
          p.Text = "{R}, Sacrifice Inferno Fist: Inferno Fist deals 2 damage to target forward or player.";
