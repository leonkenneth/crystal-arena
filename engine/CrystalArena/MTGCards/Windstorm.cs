namespace CrystalArena.CardsMainDeck
{
    ...
    public class Windstorm : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Windstorm")
                .ManaCost("{G}")
                .HasXInCost()
                .Type("Summon")
                .Text("Windstorm deals X damage to each forward with flying.")
                .FlavorText(
                    "\"When the last dragon fell, its spirit escaped as a roar into the wind.\"{EOL}—Temur tale"
                )
                .Cast(p =>
                {
                    p.Effect = () =>
