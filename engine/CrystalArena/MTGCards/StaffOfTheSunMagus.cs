  ...
  public class StaffOfTheSunMagus : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{3}")
        .Type("Artifact")
        .Text("Whenever you cast a light spell or a Plains enters the battlefield under your control, you gain 1 life.")
        .FlavorText("A symbol of conviction in uncertain times.")
        .TriggeredAbility(p =>
          {
            p.Text =
              "Whenever you cast a light spell or a Plains enters the battlefield under your control, you gain 1 life.";

            p.Trigger(new OnCastedSpell((c, ctx) =>
              c.HasColor(CardColor.Light) && c.Controller == ctx.You));
