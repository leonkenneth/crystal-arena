namespace CrystalArena.CardsMainDeck
{
    ...
    public class JungleHollow : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Jungle Hollow")
                .Type("Backup")
                .Text(
                    "Jungle Hollow enters the battlefield tapped.{EOL}When Jungle Hollow enters the battlefield, you gain 1 life.{EOL}{T}: Add {B} or {G} to your mana pool."
                )
