  ...
  public class StaffOfTheDeathMagus : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{3}")
        .Type("Artifact")
        .Text("Whenever you cast a dark spell or a Swamp enters the battlefield under your control, you gain 1 life.")
        .FlavorText("A symbol of ambition in ruthless times.")
        .TriggeredAbility(p =>
          {
            p.Text =
              "Whenever you cast a dark spell or a Swamp enters the battlefield under your control, you gain 1 life.";

            p.Trigger(new OnCastedSpell((c, ctx) => 
              c.HasColor(CardColor.Dark) && c.Controller == ctx.You));
