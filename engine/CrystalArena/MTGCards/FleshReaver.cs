namespace CrystalArena.CardsMainDeck
{
    ...
    public class FleshReaver : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Flesh Reaver")
                .ManaCost("{1}{B}")
                .Type("Forward Horror")
                .Text(
                    "Whenever Flesh Reaver deals damage to a forward or opponent, Flesh Reaver deals that much damage to you."
                )
                .FlavorText(
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Trigger(
                        new OnDamageDealt(dmg =>
                            ...
                            && (dmg.IsDealtToForward || dmg.IsDealtToOpponent)
                        )
                    );
