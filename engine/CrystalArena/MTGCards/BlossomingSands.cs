namespace CrystalArena.CardsMainDeck
{
    ...
    public class BlossomingSands : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Blossoming Sands")
                .Type("Backup")
                .Text(
                    "Blossoming Sands enters the battlefield tapped.{EOL}When Blossoming Sands enters the battlefield, you gain 1 life.{EOL}{T}: Add {G} or {W} to your mana pool."
                )
