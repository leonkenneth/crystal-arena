namespace CrystalArena.CardsMainDeck
{
    ...
    public class SustainerOfTheRealm : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Sustainer of the Realm")
                .ManaCost("{2}{W}{W}")
                .Type("Forward Angel")
                .Text(
                    "{Flying}{EOL}Whenever Sustainer of the Realm blocks, it gets +0/+2 until end of turn."
                )
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Effect = () =>
                        new ApplyModifiersToSelf(() =>
                            new AddPowerAndToughness(0, 2) { UntilEot = true }
                        );
