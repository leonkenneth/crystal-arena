namespace CrystalArena.CardsMainDeck
{
    ...
    public class RotfeasterMaggot : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Rotfeaster Maggot")
                .ManaCost("{4}{B}")
                .Type("Forward — Insect")
                .Text(
                    "When Rotfeaster Maggot enters the battlefield, exile target forward card from a breakZone. You gain life equal to that card's toughness."
                )
                ...
                .TriggeredAbility(p =>
                {
                    ...
                    p.Effect = () =>
                        new CompoundEffect(
                            ...
                            new ChangeLife(
                                amount: P(
                                    e => e.Target.Card().Toughness.GetValueOrDefault(),
