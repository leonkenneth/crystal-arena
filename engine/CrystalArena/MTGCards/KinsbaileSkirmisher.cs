  ...
  public class KinsbaileSkirmisher : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("When Kinsbaile Skirmisher enters the battlefield, target forward gets +1/+1 until end of turn.")
        .FlavorText("\"If a boggart even dares breathe near one of my kin, I'll know. And I'll not be happy.\"")
        .Power(2)
        .Toughness(2)
        .TriggeredAbility(p =>
          {
            p.Text = "When Kinsbaile Skirmisher enters the battlefield, target forward gets +1/+1 until end of turn.";
