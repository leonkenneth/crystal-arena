namespace CrystalArena.CardsMainDeck
{
    ...
    public class ShivanHellkite : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Shivan Hellkite")
                .ManaCost("{5}{R}{R}")
                .Type("Forward Dragon")
                .Text(
                    "{Flying}{EOL}{1}{R}: Shivan Hellkite deals 1 damage to target forward or player."
                )
                .FlavorText(
                ...
                .ActivatedAbility(p =>
                {
                    p.Text = "{1}{R}: Shivan Hellkite deals 1 damage to target forward or player.";
