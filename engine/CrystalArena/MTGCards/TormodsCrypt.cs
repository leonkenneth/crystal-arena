namespace CrystalArena.CardsMainDeck
{
    ...
    public class TormodsCrypt : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Tormod's Crypt")
                .ManaCost("{0}")
                .Type("Artifact")
                .Text(
                    "{T}, Sacrifice Tormod's Crypt: RemoveFromPlay all cards from target player's breakZone."
                )
                ...
                .ActivatedAbility(p =>
                {
                    ...
                    p.Effect = () => new RemoveFromPlayAllCards(from: Zone.BreakZone);
