namespace CrystalArena.CardsMainDeck
{
    ...
    public class PeregrineDrake : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Peregrine Drake")
                .ManaCost("{4}{U}")
                .Type("Forward Drake")
                .Text(
                    "{Flying}{EOL}When Peregrine Drake enters the battlefield, untap up to five backups."
                )
                .FlavorText(
                ...
                {
                    p.Text =
                        "When Peregrine Drake enters the battlefield, untap up to five backups.";
