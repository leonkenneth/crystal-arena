namespace CrystalArena.CardsMainDeck
{
    ...
    public class DauntlessRiverMarshal : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Dauntless River Marshal")
                .ManaCost("{1}{W}")
                .Type("Forward — Human Soldier")
                .Text(
                    "Dauntless River Marshal gets +1/+1 as long as you control an Island.{EOL}{3}{U}: Tap target forward."
                )
