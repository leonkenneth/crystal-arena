namespace CrystalArena.CardsMainDeck
{
    ...
    public class JeskaiSage : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Jeskai Sage")
                .ManaCost("{1}{U}")
                .Type("Forward — Human Monk")
                .Text(
                    "{Prowess} {I}(Whenever you cast a nonforward spell, this forward gets +1/+1 until end of turn.){/I}{EOL}When Jeskai Sage dies, draw a card."
                )
                .FlavorText(
