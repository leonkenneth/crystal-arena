  ...
  public class HonorsReward : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .ManaCost("{2}{W}")
        .Type("Summon")
        .Text("You gain 4 life. Bolster 2.{I}(Choose a forward with the least toughness among forwards you control and put two +1/+1 counters on it.){/I}")
        .FlavorText("It seldom rains in Abzan backups. When it does, the khan marks the occasion by honoring the families of the fallen.")
        .Cast(p =>
        {
          ...
          p.TargetSelector.AddEffect(
            trg => trg
            .Is.Card(c => c.Is().Forward && 
              c.Controller.Battlefield.Forwards.All(x => x.Toughness >= c.Toughness), ControlledBy.SpellOwner)
            .On.Battlefield(),
