namespace CrystalArena.CardsMainDeck
{
    ...
    public class BarrinMasterWizard : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Barrin, Master Wizard")
                .ManaCost("{1}{U}{U}")
                .Type("Legendary Forward Human Wizard")
                .Text("{2}, Sacrifice a permanent: Return target forward to its owner's hand.")
                .FlavorText(
                ...
                {
                    p.Text =
                        "{2}, Sacrifice a permanent: Return target forward to its owner's hand.";
                    ...
                    p.TargetSelector.AddCost(
                        ...
                        .AddEffect(
                            trg => trg.Is.Card(c => c.Is().Forward).On.Battlefield(),
                            trg => trg.Message = "Select a forward to bounce."
                        );
