  ...
  public class Outmaneuver : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Type("Summon")
        .Text("X target blocked forwards assign their combat damage this turn as though they weren't blocked.")
        .FlavorText("Push one goblin into sight, an' run a lot. That's tactics.")
        .Cast(p =>
          {
            p.Text = "X target blocked forwards assign their combat damage this turn as though they weren't blocked.";
