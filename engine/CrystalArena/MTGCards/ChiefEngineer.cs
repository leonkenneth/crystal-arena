namespace CrystalArena.CardsMainDeck
{
    ...
    public class ChiefEngineer : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Chief Engineer")
                .ManaCost("{1}{U}")
                .Type("Forward — Vedalken Artificer")
                .Text(
                    "Artifact spells you cast have convoke. {I}(Your forwards can help cast those spells. Each forward you tap while casting an artifact spell pays {1} for or one mana of that forward's color.){/I}"
                )
