namespace CrystalArena.CardsMainDeck
{
    ...
    public class CranialArchive : CardTemplateSource
    {
        ...
        {
            yield return Card.Named("Cranial Archive")
                .ManaCost("{2}")
                .Type("Artifact")
                .Text(
                    "{2},RemoveFromPlay Cranial Archive: Target player shuffles his or her breakZone into his or her library. Draw a card."
                )
                .FlavorText(
