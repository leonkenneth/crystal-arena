namespace CrystalArena
{
  ...
  public abstract class UnorderedZone : GameObject, IEnumerable<Card>, IHashable, IZone
  {
    ...
    public IEnumerable<Card> Forwards { get { return _cards.Where(card => card.Is().Forward); } }
    public bool IsEmpty { get { return _cards.Count == 0; } }
    public IEnumerable<Card> Backups { get { return _cards.Where(card => card.Is().Backup); } }
