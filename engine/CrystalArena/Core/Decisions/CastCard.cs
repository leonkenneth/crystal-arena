namespace CrystalArena.Decisions
{
    ...
    public class CastCard : Decision
    {
        ...
        public CastCard(Player controller, Action<Params> setParameters)
            : base(
                controller,
                () => new UiHandler(),
                () => new MachineHandler(),
        ...
        private class MachineHandler : Handler, ISearchNode, IMachineExecutionPlan
        {
            ...
            {
                return string.Format("{0}, {1} casts {2}", Game.Turn.Step, Controller, D._p.Card);
            }
            ...
            {
                return new PlayableGenerator(Controller, Game).GetPlayablesForSpell(
                    D._p.Card,
        ...
        private class UiHandler : Handler
        {
            ...
            {
                var prerequisites = D
                    ._p.Card.GetCastPrerequisites(D._p.PayManaCost)
