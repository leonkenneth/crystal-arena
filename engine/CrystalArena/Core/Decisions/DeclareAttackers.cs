  ...
  public class DeclareAttackers : Decision
  {
    ...
    private abstract class Handler : DecisionHandler<DeclareAttackers, ChosenAttackers>
    {
      ...
      protected List<Card> ForwardsThatMustAttack
      {
        get
        {
          return _forwardsThatMustAttack ?? (_forwardsThatMustAttack = 
            D.Controller.Battlefield.ForwardsThatCanAttack
      ...
      protected override bool ShouldExecuteQuery { get { return D.Controller.Battlefield.HasForwardsThatCanAttack; } }
      ...
      protected override void ExecuteQuery()
      {
        ...
        while (true)
        {
          var attackerSpec = new IsValidTargetBuilder()
            .Is.Card(c =>
            {
              return c.CanAttack && c.Controller == D.Controller && c.CombatCost <= availableMana && c.CanPartyAttackWith(result.Attackers.Select(a => a.Card));
            })
            .On.Battlefield();
