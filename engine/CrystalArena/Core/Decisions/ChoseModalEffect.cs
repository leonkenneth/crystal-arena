...
namespace CrystalArena.Decisions
{
    ...
    public class ChoseModalEffect : Decision
    {
        ...
        public ChoseModalEffect(Player controller, Action<Params> setParameters)
            : base(
                controller,
                () => new UiHandler(),
                () => new MachineHandler(),
        ...
        private abstract class Handler : DecisionHandler<ChoseModalEffect, ChosenModalEffectIndex>
        {
            ...
            public override void ProcessResults()
            {
                ...
                var chosenEffect = D._p.Effect.ChildEffectFactories[
                    chosenModalEffectIndex.Indices[0]
                ];
