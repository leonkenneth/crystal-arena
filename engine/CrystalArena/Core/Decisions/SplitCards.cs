    ...
    public class SplitCards : Decision
    {
        ...
        private class UiHandler : Handler
        {
            protected override void ExecuteQuery()
            {
                ...
                {
                    var orderDialogPositive = Ui.Dialogs.CardOrder.Create(
                        positiveGroup,
                        D._p.PositiveText
                    );
                    Ui.Shell.ShowModalDialog(
                ...
                {
                    var orderDialogNegative = Ui.Dialogs.CardOrder.Create(
                        negativeGroup,
                        D._p.NegativeText
                    );
                    Ui.Shell.ShowModalDialog(
                ...
                Result = new Split(new IEnumerable<Card>[] { positiveGroup, negativeGroup });
            }
        }
    }
}
