namespace CrystalArena.Decisions
{
  ...
  public class DeclareBlocker : Decision
  {
    ...
    private class MachineHandler : Handler, IMachineExecutionPlan, ISearchNode
    {
      ...
      private void GetBlockersDeclarations(List<Card> attackers, List<ChosenBlocker> strategies)
      {
        ...
        var strategy2 = BlockStrategy.ChooseBlocker(new BlockStrategyParameters
          {
            Attackers = attackers,
    ...
    private class PlaybackHandler : Handler
    {
      ...
      protected override void ExecuteQuery()
      {
        Result = (ChosenBlocker) Game.Recorder.LoadDecisionResult();
      }
    }
    ...
    private class UiHandler : Handler
    {
      ...
      private bool IsValidBlockerDeclaration(ChosenBlocker chosen,
