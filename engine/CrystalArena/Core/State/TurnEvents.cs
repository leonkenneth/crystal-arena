namespace CrystalArena
{
            ...
            IReceive<AbilityActivatedEvent>
    {
        ...
        private readonly TrackableList<ZoneChangedEvent> _changedZone =
            new TrackableList<ZoneChangedEvent>();
        private readonly TrackableList<DamageDealtEvent> _damaged =
            new TrackableList<DamageDealtEvent>();
        private readonly Trackable<bool> _hasActivePlayerPlayedAnySpell = new Trackable<bool>();
        private readonly Trackable<bool> _hasAnythingBeenPlayedOrActivatedDuringThisStep =
            new Trackable<bool>();
        private readonly TrackableList<LifeChangedEvent> _lifeChanged =
            new TrackableList<LifeChangedEvent>();
