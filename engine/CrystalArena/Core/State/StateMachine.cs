namespace CrystalArena
{
  ...
  public class StateMachine : GameObject, ICopyContributor
  {
    ...
    private List<StepNode> CreateStepNodes()
    {
      ...
      declareBlockers = NewStep(Step.DeclareBlocker,
        new Action[]
          {
            DeclareBlocker,
            SetDamageAssignments,
          },
        next: () => Combat.AnyForwardsWithFirstStrike()
      ...
      firstStrikeCombatDamage = NewStep(Step.FirstStrikeCombatDamage,
        ...
        next: () => Combat.AnyForwardsWithNormalStrike()
          ? combatDamage
          : endofCombat,
        getsPriority: true);
    ...
    {
      var duplicateLegends = player.Battlefield.Legends
