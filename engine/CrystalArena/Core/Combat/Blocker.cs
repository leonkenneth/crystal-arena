namespace CrystalArena
{
  ...
  {    
    ...
    public bool HasDeathTouch { get { return Card.Has().Deathtouch; } }
    ...
    {
      return QuickCombat.CanBlockerBeDealtLeathalCombatDamage(new Party(Combat.Attackers), Card);
    }

    public bool CanKillAnyAttacker()
    {
      return Combat.Attackers.Any(x => QuickCombat.CanAttackerBeDealtLeathalDamage(x, this.Card));
    }
  }
}