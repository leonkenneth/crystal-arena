    ...
    public class Forcing : DraftingStrategy
    {
        ...
        private Card BlockPrimaryOrSnatchSecondary(List<Card> booster, int round)
        {
            ...
            var secondaryColor = SecondaryColor.HasValue
                ...
                : In.Where(x => x.Color != PrimaryColor)
            ...
            var primaryRating =
                primaryPick != null ? GetRating(primaryPick, round) : PlayableThreshold;
            var secondaryRating =
                secondaryPick != null ? GetRating(secondaryPick, round) : PlayableThreshold;
