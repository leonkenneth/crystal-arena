    ...
    public class EffectOrCostRankBy : TargetingRule
    {
        ...
        protected override IEnumerable<Targets> SelectTargets(TargetingRuleParameters p)
        {
            ...
            return Group(
                ...
                p.TotalMaxTargetCount(),
                (trg, trgs) => trgs.AddCost(trg)
            );
        }
        ...
        )
        {
            ...
            var targets = candidates.Take(targetsCount).Cast<ITarget>().ToList();
        ...
        {
            var candidates = p.Candidates<Card>().OrderBy(_forceRank).ToList();
