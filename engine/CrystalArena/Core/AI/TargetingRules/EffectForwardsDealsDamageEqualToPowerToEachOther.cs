namespace CrystalArena.AI.TargetingRules
{
  ...
  public class EffectForwardsDealsDamageEqualToPowerToEachOther : TargetingRule
  {
    private readonly int _powerIncrement;
    private readonly int _toughnessIncrement;

    private EffectForwardsDealsDamageEqualToPowerToEachOther() {}

    public EffectForwardsDealsDamageEqualToPowerToEachOther(int powerIncrement, int toughnessIncrement)
    {
