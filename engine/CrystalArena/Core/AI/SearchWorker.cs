namespace CrystalArena.AI
{
    ...
    public class SearchWorker
    {
        ...
        private InnerResult ParentResult
        {
            get { return _parentResult.Value; }
            set { _parentResult.Value = value; }
        }
        private int ResultIndex
        {
            get { return _moveIndex.Value; }
            set { _moveIndex.Value = value; }
        }
        public int SubTreesPrunned { get; private set; }

        private int SearchDepth
        {
            get { return _search.GetCurrentDepthInSteps(_game.Turn.StepCount); }
        }
