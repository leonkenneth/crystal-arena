...
namespace CrystalArena.AI
{
    public class BlockerEvaluation
    {
        ...
        {
            var results = new Results { DamageDealt = 0, ReceivesLeathalDamage = false };
            ...
            var attackerDealtAmount = QuickCombat
                .GetAmountOfDamagePartyWillDealToForward2(party, forward2: _p.Blocker.Card)
                .Total;
            ...
            results.ReceivesLeathalDamage =
                results.ReceivesLeathalDamage || attackerDealtAmount >= GetBlockerLifepoints();
