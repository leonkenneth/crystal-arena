...
namespace CrystalArena.AI
{
    ...
    public class Search
    {
        ...
        private readonly Dictionary<object, SearchWorker> _workers =
            new Dictionary<object, SearchWorker>();
        ...
        public int Result
        {
            get { return _root.BestMove.GetValueOrDefault(); }
        }
        public int SearchUntilDepth
        {
            get { return _game.Turn.StepCount + _p.SearchDepth; }
        }
