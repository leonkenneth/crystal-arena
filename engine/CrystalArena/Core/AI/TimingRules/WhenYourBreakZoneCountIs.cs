namespace CrystalArena.AI.TimingRules
{
  ...
  public class WhenYourBreakZoneCountIs : TimingRule
  {
    ...
    public WhenYourBreakZoneCountIs(Func<Card, bool> selector, int? minCount = 1, int? maxCount = null)
      : this(minCount, maxCount, (c, g) => selector(c)) {}

    public WhenYourBreakZoneCountIs(int? minCount = 1, int? maxCount = null, Func<Card, Game, bool> selector = null)
    {
      _maxCount = maxCount;
