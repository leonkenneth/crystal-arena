namespace CrystalArena.AI.TimingRules
{
    ...
    public abstract class TimingRule : MachinePlayRule
    {
        ...
        public void Process2(ActivationContext c)
        {
            ...
            {
                var p = new TimingRuleParameters(
                    c.Card,
                    targetsCombination.Targets,
                    targetsCombination.X
                );
        ...
        protected bool CanBeDestroyed(
            ...
            bool considerCombat = true
        )
        {
            if (considerCombat && Turn.Step == Step.DeclareBlocker && Stack.IsEmpty)
            {
