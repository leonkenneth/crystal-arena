namespace CrystalArena.AI
{
  ...
  {    
    ...
    {
      return Stack.IsEmpty && Turn.Step == Step.DeclareBlocker && controller.IsActive == false && Combat.BlockersCount > 0;
    }

    protected bool IsAfterOpponentDeclaresBlocker(Player controller)
    {
      return Stack.IsEmpty && Turn.Step == Step.DeclareBlocker && controller.IsActive;
    }
