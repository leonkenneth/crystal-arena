namespace CrystalArena.Triggers
{
    ...
    public abstract class Trigger : GameObject, IHashable
    {
        ...
        public TriggerPredicate Condition = delegate
        {
            return true;
        };
        ...
        {
            get { return Ability.OwningCard; }
        }
        public Player Controller
        {
            get { return Ability.OwningCard.Controller; }
        }
        ...
        public class Context
        {
            ...
            public Card OwningCard
            {
                get { return _trigger.OwningCard; }
            }
            public Player You
            {
                get { return _trigger.Controller; }
            }
            public Player Opponent
            {
                get { return _trigger.Controller.Opponent; }
            }
            public TurnInfo Turn
            {
                get { return _game.Turn; }
            }
            public Players Players
            {
                get { return _game.Players; }
            }
