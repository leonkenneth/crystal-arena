namespace CrystalArena
{
    ...
    public class PermanentCountManaOutput : ManaOutput, IReceive<ZoneChangedEvent>
    {
        ...
        public PermanentCountManaOutput(
            ManaColor color,
        ...
        {
            if (
                _controlledBy == ControlledBy.SpellOwner
                && message.Controller != ManaAbility.SourceCard.Controller
            )
            {
                return;
            }
            ...
            if (
                _controlledBy == ControlledBy.Opponent
                && message.Controller == ManaAbility.SourceCard.Controller
            )
            {
                return;
