namespace CrystalArena.Costs
{
    ...
    public class AggregateCost : Cost
    {
        ...
        public override ManaAmount GetManaCost()
        {
            ...
            return payMana == null ? base.GetManaCost() : payMana.GetManaCost();
        }
        ...
        public override void Initialize(
            ...
            Card card,
            Game game,
            TargetValidator validator = null
        )
        {
        ...
        public override CanPayResult CanPay(bool payManaCost)
        {
            ...
            var childResults = _costs.Select(cost => cost.CanPayPartial(payManaCost)).ToList();

            var childrenWithXInCost = childResults.Where(x => x.MaxX.HasValue).ToArray();
