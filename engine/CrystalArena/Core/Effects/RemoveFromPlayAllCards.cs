namespace CrystalArena.Effects
{
  ...
  public class RemoveFromPlayAllCards : Effect
  {
    ...
    public RemoveFromPlayAllCards(Zone from = Zone.Battlefield, Func<Effect, Card, bool> filter = null)
    {
      _from = from;
    ...
    private IEnumerable<Card> GetCards()
    {
      ...
      if (_from == Zone.BreakZone)
      {
        ...
        return Players.Player1.BreakZone.Where(c => _filter(this, c)).Concat(Players.Player2.BreakZone.Where(c => _filter(this, c))).ToList();
      }
