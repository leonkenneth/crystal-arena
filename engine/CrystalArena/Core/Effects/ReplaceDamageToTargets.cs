...
namespace CrystalArena.Effects
{
    ...
    public class ReplaceDamageToTargets : Effect
    {
        ...
        public ReplaceDamageToTargets(
            Func<ITarget, ReplaceDamage> damageReplacementFactory,
            bool untilEot
        )
        {
        ...
        protected override void ResolveEffect()
        {
            ...
            {
                var modifier = new AddDamageRedirection(
                    (modifier) => _damageReplacementFactory(target)
                )
                {
                    UntilEot = _untilEot,
                };
