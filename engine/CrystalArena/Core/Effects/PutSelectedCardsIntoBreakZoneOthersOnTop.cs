namespace CrystalArena.Effects
{
    ...
    public class PutSelectedCardsIntoBreakZoneOthersOnTop
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, Ordering>
    {
        ...
        public PutSelectedCardsIntoBreakZoneOthersOnTop(int count, int? countBreakZone = null)
        {
            _count = count;
        ...
        {
            var cards = Controller.MainDeck.Take(_count).ToList();
        ...
        ChosenCards IChooseDecisionResults<List<Card>, ChosenCards>.ChooseResult(
        ...
        public void ProcessResults(ChosenCards results)
        {
            ...
            var cards = Controller.MainDeck.Take(_count - results.Count).ToList();
