namespace CrystalArena.Effects
{
            ...
            IChooseDecisionResults<List<Card>, Split>
    {
        ...
        {
            var backupCount =
                Controller.Battlefield.Backups.Count() + Controller.Hand.Backups.Count();
            ...
            top = top.OrderBy(x => x.Is().Backup ? int.MinValue : -x.Score).ToList();

            return new Split(new[] { top, bottom });
        }
