namespace CrystalArena.Effects
{
    ...
    public class ApplyActionToPermanentOrApplyActionToOwner
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public ApplyActionToPermanentOrApplyActionToOwner(
            Func<Card, bool> validator = null,
            Action<Player, Card> actionToPermament = null,
            Action<Player, Card> actionToOwner = null,
            bool canSelectSelf = true,
            Func<Player, Card, bool> shouldPayAi = null,
            string text = null,
