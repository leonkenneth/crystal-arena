namespace CrystalArena.Effects
{
    ...
    public class PutCardsFromBreakZoneToBattlefield
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        private PutCardsFromBreakZoneToBattlefield() { }

        public PutCardsFromBreakZoneToBattlefield(
            Func<Card, bool> filter,
            Action<Card> modify = null,
        ...
        {
            var cards = player.BreakZone.Where(_filter).ToList();
        ...
        public ChosenCards ChooseResult(List<Card> candidates)
        {
            ...
            if (result == null)
            {
                result = candidates.OrderBy(x => x.Score).FirstOrDefault();
            }
