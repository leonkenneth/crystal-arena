namespace CrystalArena.Effects
{
    ...
    public class DealDamageToForwardWithAttributeSelectIfMoreThanOne
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public DealDamageToForwardWithAttributeSelectIfMoreThanOne(
            int amount,
            Func<Card, int?, bool> hasAttribute,
            Func<Game, int?> getAttribute
        )
        {
            _amount = amount;
