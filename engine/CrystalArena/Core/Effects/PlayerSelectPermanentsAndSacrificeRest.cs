namespace CrystalArena.Effects
{
    ...
    public class PlayerSelectPermanentsAndSacrificeRest
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public PlayerSelectPermanentsAndSacrificeRest(
            DynParam<int> toUpCount,
            DynParam<Player> player,
        ...
        {
            return candidates.OrderBy(x => -x.Score).Take(_toUpCount).ToList();
        }

        public void ProcessResults(ChosenCards results)
        {
            var permanents = _player
                .Value.Battlefield.Where(_filter)
