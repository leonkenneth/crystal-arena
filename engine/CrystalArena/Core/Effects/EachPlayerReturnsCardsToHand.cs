namespace CrystalArena.Effects
{
    ...
    public class EachPlayerReturnsCardsToHand
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public EachPlayerReturnsCardsToHand(
            int minCount,
            int maxCount,
            Zone zone,
            bool aiOrdersByDescendingScore,
            string text,
        ...
        public ChosenCards ChooseResult(List<Card> candidates)
        {
            ...
            {
                return candidates.OrderBy(x => -x.Score).Take(_minCount).ToList();
            }

            return candidates.OrderBy(x => x.Score).Take(_maxCount).ToList();
        }
