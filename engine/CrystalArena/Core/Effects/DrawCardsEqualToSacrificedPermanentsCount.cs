namespace CrystalArena.Effects
{
    ...
    public class DrawCardsEqualToSacrificedPermanentsCount
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public DrawCardsEqualToSacrificedPermanentsCount(
            string text,
        ...
        public ChosenCards ChooseResult(List<Card> candidates)
        {
            ...
            var backups = candidates.Where(x => x.Is().Backup).OrderBy(x => x.Score).ToList();
