namespace CrystalArena.Effects
{
    ...
    internal class RevealTopCardsPutOneInHandOthersIntoBreakZone
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        public RevealTopCardsPutOneInHandOthersIntoBreakZone(
            int cardsToReveal,
        ...
        public void ProcessResults(ChosenCards results)
        {
            ...
            var notPicked = Controller.MainDeck.Take(_cardsToReveal - results.Count).ToList();
        ...
        {
            var cards = Controller.MainDeck.Take(_cardsToReveal).ToList();
