  ...
  public class DealDamageToForwardsAndPlayers : Effect
  {
    ...
    public DealDamageToForwardsAndPlayers(
      ...
      Func<Effect, Player, bool> filterPlayer = null) :
        this(delegate { return amountForward; }, delegate { return amountPlayer; }, filterForward, filterPlayer) {}
    ...
    public DealDamageToForwardsAndPlayers(
      ...
      Func<Effect, Player, bool> filterPlayer = null)
    {
      _amountForward = amountForward ?? delegate { return 0; };
      _amountPlayer = amountPlayer ?? delegate { return 0; };
      _filterForward = filterForward ?? delegate { return true; };
