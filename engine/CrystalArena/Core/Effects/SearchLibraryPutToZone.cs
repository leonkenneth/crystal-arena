namespace CrystalArena.Effects
{
  ...
  public class SearchMainDeckPutToZone : Effect, IProcessDecisionResults<ChosenCards>,
    IChooseDecisionResults<List<Card>, ChosenCards>, ICardValidator
  {
    ...
    private SearchMainDeckPutToZone() { }

    public SearchMainDeckPutToZone(Zone zone, EffectAction<Card> afterPutToZone = null,
    ...
    public static int ChooseBackupToPutToBattlefield(Card card, Context ctx)
    {
