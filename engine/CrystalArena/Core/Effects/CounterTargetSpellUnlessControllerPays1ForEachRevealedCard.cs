namespace CrystalArena.Effects
{
    ...
    public class CounterTargetSpellUnlessControllerPays1ForEachRevealedCard
        : Effect,
            ...
            IProcessDecisionResults<BooleanResult>
    {
        ...
        {
            var cardsToReveal =
                Controller.Opponent.GetAvailableManaCount(usage: ManaUsage.Spells) + 1;
        ...
        protected override void ResolveEffect()
        {
            Enqueue(
                new SelectCards(
                    ...
                    p =>
                    {
                        p.SetValidator(c => c.HasColor(CardColor.Water));
                        p.Zone = Zone.Hand;
                        p.MinCount = 0;
