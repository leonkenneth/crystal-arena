namespace CrystalArena.Effects
{
    ...
    public class ForwardGetsPwtForEachRevealedCard
        : Effect,
            ...
            IChooseDecisionResults<List<Card>, ChosenCards>
    {
        ...
        private ForwardGetsPwtForEachRevealedCard() { }

        public ForwardGetsPwtForEachRevealedCard(
            int power,
            int toughness,
        ...
        public void ProcessResults(ChosenCards results)
        {
            ...
            var modifier = new AddPowerAndToughness(
                _power * results.Count,
                _toughness * results.Count
            )
            {
                UntilEot = true,
            };
