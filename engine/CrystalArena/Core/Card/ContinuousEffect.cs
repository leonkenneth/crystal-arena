namespace CrystalArena
{
    ...
    public class ContinuousEffect
        : GameObject,
            ...
            IReceive<PermanentModifiedEvent>
    {
        ...
        public void Receive(ZoneChangedEvent message)
        {
            if (_isActive == false)
                return;
            if (_applyOnlyToPermanents == false)
                return;
        ...
        private Context Ctx
        {
            get { return new Context(this, Game); }
        }
        ...
        {
            return _modifiers.FirstOrDefault(x => x.Owner == permanent);
        }

        public void Activate()
        {
            var cards = _applyOnlyToPermanents ? Players.Permanents() : Players.AllCards();
        ...
        private void AddModifier(Card card)
        {
            foreach (var factory in _modifierFactories)
            {
                ...
                var p = new ModifierParameters { SourceCard = Source };
        ...
        public class Context
        {
            ...
            public Player EffectOwner
            {
                get { return _effect.Owner; }
            }
            public Player You
            {
                get { return _effect.Source.Controller; }
            }
            public Card Source
            {
                get { return _effect.Source; }
            }
            public Player Opponent
            {
                get { return You.Opponent; }
            }
        }
    }
}
