namespace CrystalArena
{
  ...
  public class SimpleAbilities : GameObject, ISimpleAbilities, IAcceptsCardModifier, IHashable, ICopyContributor
  {
    ...
    public bool UnblockableIfDedenderHasMonsters
    {
      get { return Has(Static.UnblockableIfDedenderHasMonsters); }
    }
    ...
    public bool AnyEvadingAbility
    {
      get
      {
        return Fear || Flying || Trample || Unblockable || AssignsDamageAsThoughItWasntBlocked ||
          CanOnlyBeBlockedByForwardsWithFlying || CanOnlyBeBlockedByWalls || Swampwalk || Mountainwalk || Islandwalk;
      }
    }

    public bool CanBlockOnlyForwardsWithFlying
    {
        get { return Has(Static.CanBlockOnlyForwardsWithFlying); }
    }

    public bool CanOnlyBeBlockedByForwardsWithFlying
    {
        get { return Has(Static.CanOnlyBeBlockedByForwardsWithFlying); }
    }
