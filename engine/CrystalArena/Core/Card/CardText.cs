namespace CrystalArena
{
    ...
    public class CardText : IEnumerable<Token>
    {
        ...
        private static readonly List<Func<string, Token>> TokenFactoy = new List<
            Func<string, Token>
        >
        {
    ...
    {
        public ImportantTextToken(string value)
            : base(value) { }
    }

    public class ReminderTextOpenToken : Token
    {
        public ReminderTextOpenToken()
            : base(String.Empty) { }
    }

    public class ReminderTextCloseToken : Token
    {
        public ReminderTextCloseToken()
            : base(String.Empty) { }
    }

    public class ReminderTextToken : Token
    {
        public ReminderTextToken(string value)
            : base(value) { }
    }
    ...
    {
        public ManaSymbolGroupStartToken()
            : base(String.Empty) { }
    }

    public class ManaSymbolGroupEndToken : Token
    {
        public ManaSymbolGroupEndToken()
            : base(String.Empty) { }
    }
