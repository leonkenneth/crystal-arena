namespace CrystalArena
{
    ...
    public class ColorsOfCard
        : Characteristic<List<CardColor>>,
            IEnumerable<CardColor>,
            ...
            IHashable
    {
        ...
        public ColorsOfCard(CardBase cardBase)
            : base(cardBase.Value.Colors)
        {
            _cardBase = cardBase;
        }
        ...
        {
            var hashcodes = Value.Select(item => item.GetHashCode()).ToList();
