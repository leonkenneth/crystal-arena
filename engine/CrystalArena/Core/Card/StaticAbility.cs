namespace CrystalArena
{
    ...
    public class StaticAbility
        : GameObject,
            IReceive<ControllerChangedEvent>,
            ...
            IHashable
    {
        ...
        private readonly TrackableList<ManualLifetime> _lifetimes =
            new TrackableList<ManualLifetime>();
        private readonly Func<StaticAbilityParameters.ConditionParameters, bool> _condition;

        private readonly List<ModifierFactory> _modifierFactories = new List<ModifierFactory>();
        ...
        private bool ShouldBeActivated()
        {
            return _condition == null
                || _condition(new StaticAbilityParameters.ConditionParameters(OwningCard, Game));
        }
        ...
        private void Activate()
        {
            ...
            {
                var p = new ModifierParameters { IsStatic = true, SourceCard = OwningCard };
