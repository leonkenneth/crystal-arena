namespace CrystalArena.Diagnostics
{
  using System;
...
";
    ...
    {            
      ...
      inner = inner.AppendLine(CreateZone("BreakZone", game.Players.Player1.BreakZone, 1));
      inner = inner.AppendLine(CreateZone("BreakZone", game.Players.Player2.BreakZone, 2));
      inner = inner.AppendLine(CreateZone("MainDeck", game.Players.Player1.MainDeck, 1));
      inner = inner.AppendLine(CreateZone("MainDeck", game.Players.Player2.MainDeck, 2));      
