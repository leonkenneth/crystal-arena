namespace CrystalArena.Modifiers
{
    ...
    public class ChangeToForward : Modifier, ICardModifier
    {
        ...
        public ChangeToForward(
            Func<Modifier, int> power,
            Func<Modifier, int> toughness,
            Func<Modifier, CardType> type,
        ...
        public ChangeToForward(
            Value power,
            Value toughness,
            Func<CardType, CardType> type,
            IEnumerable<CardColor> colors = null
        )
            : this(
                m => power.GetValue(m.X),
                m => toughness.GetValue(m.X),
                m => type(m.OwningCard.Type),
                colors
            ) { }
