namespace CrystalArena.Modifiers
{
  ...
  public class ChangeToForward : Modifier, ICardModifier
  {
    ...
    private ChangeToForward() { }

    public ChangeToForward(Func<Modifier, int> power, Func<Modifier, int> toughness, Func<Modifier, CardType> type,
    ...
    public ChangeToForward(Value power, Value toughness, Func<CardType, CardType> type, IEnumerable<CardColor> colors = null) : this(
