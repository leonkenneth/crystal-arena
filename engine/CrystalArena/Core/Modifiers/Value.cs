namespace CrystalArena.Modifiers
{
    ...
    public class Value
    {
        ...
        {
            get { return new Value { _type = ValueType.PlusX }; }
        }

        public static Value MinusX
        {
            get { return new Value { _type = ValueType.MinusX }; }
        }

        public static implicit operator Value(int value)
        {
            return new Value { _type = ValueType.Constant, _value = value };
        }
        ...
        {
            return new DynParam<int>(getter: (e, g) => value.GetValue(e.X));
        }
