namespace CrystalArena
{
    ...
    public class GameParameters
    {
        ...
        public PlayerType Player1Controller { get; set; }
        public PlayerType Player2Controller { get; set; }
        public int RollBack { get; private set; }
        public int? Looser { get; private set; }

        public bool IsSavedGame
        {
            get { return SavedGame != null; }
        }
        ...
        public static GameParameters Scenario(
            PlayerType player1Controller,
            PlayerType player2Controller,
        ...
        public static GameParameters Simulation(
            Deck player1Deck,
            Deck player2Deck,
            SearchParameters searchParameters
        )
