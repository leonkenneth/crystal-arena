namespace CrystalArena
{
    ...
    public abstract class Effect : GameObject, ITarget, IHasColors
    {
        ...
        public EffectPredicate ShouldResolve = delegate
        {
            return true;
        };
        ...
        public virtual int CalculateForwardDamage(Card forward)
        {
            return 0;
        }
        ...
        public virtual Effect Initialize(
            EffectParameters p,
            Game game,
            bool evaluateDynamicParameters = true
        )
        {
            Game = game;
            Source = p.Source;
        ...
        public class Context
        {
            ...
            public ITarget Target
            {
                get { return _effect.Target; }
            }
            public Player You
            {
                get { return _effect.Controller; }
            }
            public Player Opponent
            {
                get { return _effect.Controller.Opponent; }
            }
            public Card OwningCard
            {
                get { return _effect.Source.OwningCard; }
            }
            public int? X
            {
                get { return _effect.X; }
            }
            public Combat Combat
            {
                get { return _game.Combat; }
            }
