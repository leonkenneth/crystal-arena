namespace CrystalArena
{
    ...
    public class DamagePreventions : IAcceptsGameModifier, IHashable
    {
        private readonly TrackableList<DamagePrevention> _preventions =
            new TrackableList<DamagePrevention>();
        public int Count
        {
            get { return _preventions.Count; }
        }
        ...
        public int PreventDamage(PreventDamageParameters preventDamageParameters)
        {
            ...
            return Prevent(
                amount,
                (prevention) => prevention.PreventDamage(preventDamageParameters)
            );
        }
        ...
        public int PreventLifeloss(int amount, Player player, bool queryOnly = true)
        {
            return Prevent(
                amount,
                (prevention) => prevention.PreventLifeloss(amount, player, queryOnly)
            );
        }
