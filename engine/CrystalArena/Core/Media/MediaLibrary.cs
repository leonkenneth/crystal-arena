...
namespace CrystalArena.Media
{
  ...
  public static class MediaMainDeck
  {
    ...
    private static readonly Dictionary<string, Bitmap> Clipart = new Dictionary<string, Bitmap>();
    private static readonly Dictionary<string, Bitmap> CardImages = new Dictionary<string, Bitmap>();    
    ...
    public static Bitmap SingleRedPixelBitmap()
    {
      ...
      using (var stream = new MemoryStream())
      {
        ...
        using (var bitmap = new WriteableBitmap(new PixelSize(1, 1), new Vector(96, 96), Avalonia.Platform.PixelFormat.Bgra8888))
        {
