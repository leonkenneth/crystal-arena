namespace CrystalArena
{
    ...
    public static class Target
    {
        public static Zone? Zone(this ITarget target)
        {
            ...
            if (target.IsEffect())
            {
                return target.Effect().IsOnStack ? CrystalArena.Zone.Stack : CrystalArena.Zone.None;
            }
        ...
        public static object TargetTypeAndId(this ITarget target)
        {
            if (target.IsPlayer())
            {
                ...
                return new { TargetType = "Player", PlayerId = player.Id };
            }

            if (target.IsCard())
            {
                var card = target.Card();
                return new { TargetType = "Card", CardId = card.Id };
            }
