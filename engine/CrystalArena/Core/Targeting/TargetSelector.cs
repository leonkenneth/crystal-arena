namespace CrystalArena
{
    ...
    public class TargetSelector : GameObject
    {
        ...
        public int Count
        {
            get { return _costValidators.Count + _effectValidators.Count; }
        }

        public bool RequiresTargets
        {
            get { return _costValidators.Any() || _effectValidators.Any(); }
        }
        public bool RequiresCostTargets
        {
            get { return _costValidators.Count > 0; }
        }
        public bool RequiresEffectTargets
        {
            get { return _effectValidators.Count > 0; }
        }

        public List<TargetValidator> Effect
        {
            get { return _effectValidators; }
        }
        public List<TargetValidator> Cost
        {
            get { return _costValidators; }
        }
        public Func<ValidateTargetDependenciesParam, bool> ValidateTargetDependencies = delegate
        {
            return true;
        };
        ...
        public bool IsValidEffectTarget(ITarget target, object triggerMessage = null)
        {
            ...
            return _effectValidators.Any(validator =>
            {
