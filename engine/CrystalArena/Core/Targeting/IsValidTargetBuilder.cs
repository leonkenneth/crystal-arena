namespace CrystalArena
{
  ...
  public class IsValidTargetBuilder
  {
    ...
    {
      IsValidTarget = p => p.Target.IsPlayer() || (p.Target.IsCard() && p.Target.Card().Is().Forward);
      ...
      IsValidTarget = p =>
        {
          ...
          if (!p.Target.Is().Forward) return false;
    ...
    public IsValidZoneBuilder Forward(ControlledBy? controlledBy = null, bool canTargetSelf = true)
    {
