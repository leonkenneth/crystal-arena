...
namespace CrystalArena
{
    ...
    public class Game : IModifiable
    {
        ...
        private readonly TrackableList<IGameModifier> _modifiers =
            new TrackableList<IGameModifier>();
            ...
            if (p.IsSavedGame)
            {
                ...
                _stateMachine.Start(
                    () =>
                    {
                        if (p.RollBack > 0)
                        {
                            return (Turn.StateCount < p.SavedGame.StateCount - p.RollBack)
                                || (_stateMachine.HasPendingDecisions);
                        }
        ...
        {
            get { return _wasStopped.Value; }
        }
        public Combat Combat { get; private set; }
        public bool IsFinished
        {
            get { return Players.AnyHasLost() || _turnLimit < Turn.TurnCount; }
        }
        public Players Players { get; private set; }
        public int Score
        {
            get { return Players.Score; }
        }
        ...
        public void Start(
            int numOfTurns = int.MaxValue,
            bool skipPreGame = false,
            Player looser = null
        )
        {
