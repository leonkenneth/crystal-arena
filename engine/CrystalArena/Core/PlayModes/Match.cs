namespace CrystalArena
{
    ...
    public class Match
    {
        ...
        public Match(Ui ui, MatchParameters p)
        {
            Ui = ui;
            _p = p;
        ...
        {
            get { return Player1WinCount == 2 || Player2WinCount == 2; }
        }
        ...
        public void Start(
            PlayerType player1Controller = PlayerType.Human,
            PlayerType player2Controller = PlayerType.Machine
        )
        {
            Game game;
            ...
            {
                var gameParameters = GameParameters.Default(_p.Player1, _p.Player2);
                gameParameters.Player1Controller = player1Controller;
                gameParameters.Player2Controller = player2Controller;
            ...
            while (shouldPlayAnotherGame || _rematch)
            {
                ...
                game = new Game(GameParameters.Default(_p.Player1, _p.Player2));
                game.Ui = Ui;
