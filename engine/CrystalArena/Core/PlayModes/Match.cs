namespace CrystalArena
{
  ...
  public class Match
  {
    ...
    public void Start(PlayerType player1Controller = PlayerType.Human, PlayerType player2Controller = PlayerType.Machine)
    {
      Game game;
      ...
      {
        var gameParameters = GameParameters.Default(
