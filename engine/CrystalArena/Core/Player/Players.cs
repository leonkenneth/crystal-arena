namespace CrystalArena
{
    ...
    public class Players : GameObject, IEnumerable<Player>, IHashable
    {
        ...
        {
            get { return (Player1.CanMulligan) || (Player2.CanMulligan); }
        }
        ...
        {
            get { return Player1.HasPriority ? Player1 : Player2; }
        }
        public Player WithoutPriority
        {
            get { return Player1.HasPriority ? Player2 : Player1; }
        }
        ...
        public IEnumerable<Card> AllCards()
        {
            return this.SelectMany(x =>
                x.MainDeck.Concat(x.Hand)
                    .Concat(x.Battlefield)
                    .Concat(x.BreakZone)
                    .Concat(x.RemovedFromPlay)
            );
        }
