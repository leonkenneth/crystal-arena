namespace CrystalArena.Infrastructure
{
    ...
    public static class Bindable
    {
        ...
        {
            var bindingInformation = new BindingInformation<T>
            {
        ...
        public static void Property<T, TReturn>(
            this BindingInformation<T> bindingInformation,
        ...
        )
        {
            ...
            notifier.PropertyChanged += (s, e) =>
            {
                if (e.PropertyName == bindingInformation.SourceInfo.PropertyName)
                {
                    ...
                    {
                        var sourceProperty = notifier
                            .GetType()
                            .GetProperty(bindingInformation.SourceInfo.PropertyName);
                        var sourceValue = sourceProperty.GetValue(
                            bindingInformation.SourceInfo.SourceObject,
                            null
                        );
        ...
        public static SourceInfo Property<T, TReturn>(
            this T obj,
            Expression<Func<T, TReturn>> expression
        )
        {
            ...
            return new SourceInfo { PropertyName = body.Member.Name, SourceObject = obj };
        }
