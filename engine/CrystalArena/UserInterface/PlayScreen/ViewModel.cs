namespace CrystalArena.UserInterface.PlayScreen
{
    using System;
    ...
    public class ViewModel
        : ViewModelBase,
            ...
            IReceive<AbilityActivatedEvent>,
            IReceive<SearchStartedEvent>,
            IReceive<SearchFinishedEvent>,
            IReceive<DamageDealtEvent>,
            IReceive<AssignedDamageDealtEvent>,
            IReceive<CardWasRevealedEvent>,
            IReceive<PlayerFlippedCoinEvent>,
            IReceive<OptionsChosenEvent>,
            IReceive<TurnStartedEvent>,
            IReceive<ZoneChangedEvent>,
            IReceive<LifeChangedEvent>,
            ...
            IDisposable
    {
        ...
        public object LargeDialog
        {
            get { return _largeDialogs.FirstOrDefault(); }
        }
        public MagnifiedCard.ViewModel MagnifiedCard { get; set; }
        public ManaPool.ViewModel YourManaPool { get; private set; }
        public ManaPool.ViewModel OpponentsManaPool { get; private set; }
        ...
        public object SmallDialog
        {
            get { return _smallDialogs.FirstOrDefault(); }
        }
        ...
        public override object ToJson()
        {
            ...
            return new
            {
                YourManaPool = YourManaPool?.ToJson(),
                OpponentsManaPool = OpponentsManaPool?.ToJson(),
        ...
        public void Dispose()
        {
            YourManaPool.Dispose();
            OpponentsManaPool.Dispose();
        ...
        public void Receive(AssignedDamageDealtEvent message)
        {
            ...
            // before forwards go to breakZones
            Thread.Sleep(500);
        }
        ...
        public override void Initialize()
        {
            ...
            YourManaPool = ViewModels.ManaPool.Create(Players.Human);
            OpponentsManaPool = ViewModels.ManaPool.Create(Players.Computer);
        }
