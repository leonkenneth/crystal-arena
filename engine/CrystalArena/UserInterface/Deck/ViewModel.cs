namespace CrystalArena.UserInterface.Deck
{
  ...
  public class ViewModel : ViewModelBase
  {
    ...
    public IEnumerable<DeckRow> Forwards { get { return FilterRows(_deck, c => c.Is().Forward).ToList(); } }
    public IEnumerable<DeckRow> Spells { get { return FilterRows(_deck, c => !c.Is().Forward && !c.Is().Backup).ToList(); } }
    public IEnumerable<DeckRow> Backups { get { return FilterRows(_deck, c => c.Is().Backup).ToList(); } }

    public int ForwardCount { get { return FilterCards(_deck, c => c.Is().Forward).Count(); } }
    public int BackupCount { get { return FilterCards(_deck, c => c.Is().Backup).Count(); } }
    public int SpellCount { get { return FilterCards(_deck, c => !c.Is().Forward && !c.Is().Backup).Count(); } }
    ...
    [Updates("Forwards", "Spells", "Backups", "ForwardCount", "BackupCount", "SpellCount", "CardCount")]
