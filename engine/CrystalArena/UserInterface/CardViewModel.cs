namespace CrystalArena.UserInterface
{
  ...
  public class CardViewModel : ViewModelBase, IDisposable
  {
    ...
    private void Update()
    {
      ...
      Update(() => HasSummoningSickness != (Card.HasSummoningSickness && Card.Is().Forward && !Card.Has().Haste),
        () => HasSummoningSickness = Card.HasSummoningSickness && Card.Is().Forward && !Card.Has().Haste);
    }
