namespace CrystalArena.UserInterface
{
    ...
    public static class Converters
    {
        ...
        public static BooleanToVisibilityConverter BooleanToVisibility =
            new BooleanToVisibilityConverter();
        public static CardColorToCardTemplateConverter CardColorToCardTemplate =
            new CardColorToCardTemplateConverter();
        public static CardNameToCardImageConverter CardIllustrationNameToCardImage =
            new CardNameToCardImageConverter();
        public static CharacterCountToFontSizeConverter CharacterCountToFontSize =
            new CharacterCountToFontSizeConverter();
        public static LifeToColorConverter LifeToColor = new LifeToColorConverter();
        public static AvatarIdToAvatarImageConverter AvatarIdToAvatarImage =
            new AvatarIdToAvatarImageConverter();
        public static ManaCostToManaSymbolImagesConverter ManaCostToManaSymbolImages =
            new ManaCostToManaSymbolImagesConverter();
        public static SetAndRarityToSetImageConverter SetAndRaritytoSetImage =
            new SetAndRarityToSetImageConverter();
        public static ManaSymbolListToImagesConverter ManaSymbolListToImages =
            new ManaSymbolListToImagesConverter();
        ...
        public static NonZeroToCollapsedConverter NonZeroToCollapsed =
            new NonZeroToCollapsedConverter();
        public static RatingConverter Rating = new RatingConverter();
        public static BaseStrengthChangeToColorConverter BaseStrengthChangeToColor =
            new BaseStrengthChangeToColorConverter();
        ...
        public class AutoPassToImageConverter : IValueConverter
        {
            private readonly Dictionary<Pass, string> _imageNames = new Dictionary<Pass, string>
            {
                ...
                { Pass.Passive, "circle-wind.png" },
                { Pass.Never, "circle-fire.png" },
            };
            ...
            {
                var pass = (Pass)value;
                return MediaMainDeck.GetImage(_imageNames[pass]);
            }
        ...
        public class AvatarIdToAvatarImageConverter : IValueConverter
        {
            ...
            {
                var id = (int)value;
                return MediaMainDeck.GetAvatar(id);
            }
        ...
        public class CardColorToCardTemplateConverter : IValueConverter
        {
            ...
            public const string Dark = "dark-card";
            public const string Water = "water-card";
            public const string Wind = "wind-card";
            public const string Backup = "backup-card";
            public const string Multi = "multi-card";
            public const string Fire = "fire-card";
            public const string Light = "light-card";
            ...
            {
                return MediaMainDeck.GetImage(GetTemplateName((CardColor[])value) + ".png");
            }
            ...
            public string GetTemplateName(CardColor[] colors)
            {
                ...
                if (color == CardColor.Light)
                    return Light;

                if (color == CardColor.Water)
                    return Water;

                if (color == CardColor.Dark)
                    return Dark;

                if (color == CardColor.Fire)
                    return Fire;

                if (color == CardColor.Wind)
                    return Wind;
        ...
        public class CardNameToCardImageConverter : IValueConverter
        {
            ...
            )
            {
                ...
                return MediaMainDeck.GetCardImage(GetCardImageName(cardName));
            }
            ...
            public string GetCardImageName(string cardName)
            {
                ...
                var invalidCharsRemoved = cardName.Where(x => !invalidChars.Contains(x)).ToArray();

                return new string(invalidCharsRemoved).Trim().ToLower();
            }
        }
        ...
        {
            private readonly SolidColorBrush _highLife = new SolidColorBrush(
                Color.FromArgb(0xff, 0xb1, 0xff, 0x00)
            );

            //#ffb1FF00

            private readonly SolidColorBrush _lowLife = new SolidColorBrush(
                Color.FromArgb(0xff, 0xe3, 0x00, 0x00)
            );
        ...
        public class ManaCostToManaSymbolImagesConverter : IValueConverter
        {
            ...
            )
            {
                ...
                if (manaAmount.Converted == 0)
                    return new[] { MediaMainDeck.GetImage("0.png") };
                ...
                return images.Select(x => MediaMainDeck.GetImage(x + ".png"));
            }
        ...
        public class ManaSymbolListToImagesConverter : IValueConverter
        {
            ...
            )
            {
                ...
                return symbols.Select(symbolName => MediaMainDeck.GetImage(symbolName + ".png"));
            }
        ...
        public class MarkerBrushConverter : IValueConverter
        {
            ...
            private readonly SolidColorBrush _default = new SolidColorBrush(
        ...
        public class RatingConverter : IValueConverter
        {
            ...
            )
            {
                ...
                {
                    var starControl = new Image { Source = MediaMainDeck.GetImage("star.png") };
        ...
        public class SetAndRarityToSetImageConverter : IMultiValueConverter
        {
            ...
            )
            {
                ...
                return MediaMainDeck.GetSetImage(set, rarity);
            }
        }
    }
    ...
    {
        private readonly SolidColorBrush _noChange = new SolidColorBrush(
            Color.FromArgb(0xff, 0xff, 0xff, 0xff)
        );
        private readonly SolidColorBrush _decrease = new SolidColorBrush(
            Color.FromArgb(0xff, 0xe3, 0x00, 0x00)
        );
        private readonly SolidColorBrush _increase = new SolidColorBrush(
            Color.FromArgb(0xff, 0xb1, 0xff, 0x00)
        );
