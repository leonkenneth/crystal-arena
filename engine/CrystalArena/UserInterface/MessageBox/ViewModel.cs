...
namespace CrystalArena.UserInterface.MessageBox
{
  ...
  {
    public ViewModel(string message, string title, ButtonEnum buttons, DialogType dialogType = DialogType.Large)
    {
      Message = message;
      Title = title;
    ...
    public bool IsOk { get { return Buttons == ButtonEnum.Ok; } }

    public bool IsYesNo { get { return Buttons == ButtonEnum.YesNo || Buttons == ButtonEnum.YesNoCancel; } }
    public bool IsCancel { get { return Buttons == ButtonEnum.YesNoCancel; } }
