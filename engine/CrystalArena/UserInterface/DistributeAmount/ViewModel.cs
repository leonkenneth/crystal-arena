namespace CrystalArena.UserInterface.DistributeAmount
{
    ...
    public class ViewModel : ViewModelBase
    {
        ...
        {
            return new { Type = "DistributeAmount" };
        }
        ...
        public string Title
        {
            get { return string.Format("Distribute ({0} left)", _toBeAssigned); }
        }
        public IEnumerable<TargetWithValue> Targets
        {
            get { return _targets; }
        }
        public bool CanAccept
        {
            get { return _toBeAssigned == 0; }
        }
        public List<int> Distribution
        {
            get { return _targets.Select(x => x.Amount).ToList(); }
        }
