namespace CrystalArena.UserInterface.MainDeck
{
    using System;
    ...
    public class ViewModel : ViewModelBase, IDisposable
    {
        ...
        {
            return new { Type = "MainDeck", Cards = _cards.Select(x => x.ToJson()) };
        }
        ...
        public ViewModel(Player owner)
        {
            ...
            owner.MainDeck.CardAdded += OnCardAdded;
            owner.MainDeck.CardRemoved += OnCardRemoved;
            owner.MainDeck.Shuffled += OnMainDeckShuffled;
        }
        ...
        {
            _cards.AddRange(_owner.MainDeck.Select(ViewModels.SelectableCard.Create));
        }
        ...
        private void OnMainDeckShuffled(object sender, EventArgs args)
        {
            _cards.Clear();
            _cards.AddRange(_owner.MainDeck.Select(ViewModels.SelectableCard.Create));
        }
