...
namespace CrystalArena.UserInterface.SelectTarget
{
    ...
    public class ViewModel : ViewModelBase, IReceive<SelectionChanged>
    {
        ...
        public string Text
        {
            get { return TargetValidator.GetMessage(_selection.Count + 1, _x); }
        }
        public string Instructions { get; private set; }
        private bool IsDone
        {
            get { return _selection.Count >= TargetValidator.MinCount.GetValue(_x); }
        }
        public IList<ITarget> Selection
        {
