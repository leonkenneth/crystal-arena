namespace CrystalArena.UserInterface.Permanent
{
    ...
    public class ViewModel
        : CardViewModel,
            ...
            IReceive<PlayersInterestChanged>,
            IReceive<AttackerSelected>,
            IReceive<AttackerUnselected>,
            IReceive<BlockerSelected>,
            IReceive<BlockerUnselected>,
            IReceive<RemovedFromCombatEvent>,
            ...
            IReceive<TargetUnselected>
    {
        ...
        private void Activate()
        {
            ...
            Publisher.Publish(new PlayableSelected { Playable = ability });
        }
