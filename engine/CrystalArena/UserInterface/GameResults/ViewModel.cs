namespace CrystalArena.UserInterface.GameResults
{
  using System;
  ...
  public class ViewModel : ViewModelBase
  {
    ...
    public override void ReceiveMessageType(string messageType, string message)
    {
      if (messageType == "LeaveMatch")
        LeaveMatch();
      else if (messageType == "NextGame")
        NextGame();
      else
