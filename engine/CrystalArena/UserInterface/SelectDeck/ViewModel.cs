namespace CrystalArena.UserInterface.SelectDeck
{
    ...
    public class ViewModel : ViewModelBase
    {
        ...
        private readonly List<UserInterface.Deck.ViewModel> _decks =
            new List<UserInterface.Deck.ViewModel>();

        private UserInterface.Deck.ViewModel _selected;

        public override object ToJson()
        {
            return new { Type = "SelectDeck" };
        }
        ...
        public virtual UserInterface.Deck.ViewModel Selected
        {
            ...
            set
            {
                ...
                _selected.SelectedCardChanged += delegate
                {
        ...
        public List<UserInterface.Deck.ViewModel> Decks
        {
            get { return _decks; }
        }
        ...
        private UserInterface.Deck.ViewModel CreateReadonlyDeckVm(Deck deck)
        {
            ...
            deckVm.OnAdd = delegate
            {
                return false;
            };
            deckVm.OnRemove = delegate
            {
                return false;
            };
            return deckVm;
