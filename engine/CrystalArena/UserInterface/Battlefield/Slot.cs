namespace CrystalArena.UserInterface.Battlefield
{
    ...
    public class Slot : IDisposable
    {
        ...
        private readonly BindableCollection<UserInterface.Permanent.ViewModel> _permanents =
            new BindableCollection<UserInterface.Permanent.ViewModel>();

        public object ToJson()
        {
            return new { Permanents = Permanents.Select(x => x.ToJson()) };
        }
        ...
        public IEnumerable<UserInterface.Permanent.ViewModel> Permanents
        {
        ...
        public void Add(UserInterface.Permanent.ViewModel viewModel)
        {
            ...
            {
                var insertAt = GetMonsterOrEquipmentPosition(viewModel.Card);
        ...
        {
            return viewModel.Card.Is().Aura
                ? ContainsAttachmentTarget(viewModel.Card)
                : _accepts(viewModel);
        }
        ...
        private int? GetMonsterOrEquipmentPosition(Card card)
        {
            int insertAt;
