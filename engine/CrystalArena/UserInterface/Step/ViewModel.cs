...
namespace CrystalArena.UserInterface.Step
{
    using System.Linq;
    using Events;
    ...
    public class ViewModel : ViewModelBase, IReceive<StepStartedEvent>
    {
        ...
        public Pass AutoPass
        {
            get { return Ui.Configuration.GetAutoPassConfiguration(_steps[0]); }
        }
