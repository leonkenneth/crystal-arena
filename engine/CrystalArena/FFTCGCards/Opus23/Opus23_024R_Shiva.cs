...
public class Opus23_024R_Shiva : CardTemplateSource
{
    ...
    {
        yield return Card.Code("23-024R")
            .Named("Shiva")
            .Cost(2, "I")
            .Category("FFL")
            .Summon()
            ...
            {
                p.Text =
                    "Choose 1 Forward. Dull it and Freeze it. During this turn, if it deals damage to a Forward or a player, the damage becomes 0 instead.";
