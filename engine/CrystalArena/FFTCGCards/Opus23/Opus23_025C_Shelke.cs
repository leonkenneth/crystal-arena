    ...
    public override IEnumerable<CardTemplate> GetCards()
    {
        yield return Card
            ...
            .TriggeredAbility(p =>
            {
                ...
                p.Trigger(new OnZoneChanged(to: Zone.Battlefield, selector: ((card, ctx) => card.HasJob("Tsviets"))));
            ...
            .ActivatedAbility(p =>
            {
                ...
                p.Effect = () =>
                    new ApplyModifiersToSelf(() => new AddPowerAndToughness(+3000, +3000) { UntilEot = true });
            });
    }
}