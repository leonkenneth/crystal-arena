...
public class Opus23_005R_Golbez : CardTemplateSource
{
    ...
    {
        yield return Card.Code("23-005R")
            .Named("Golbez")
            .Cost(5, "R")
            .Forward()
            .Power(9000)
            ...
            .ActivatedAbility(p =>
            {
                ...
                p.Effect = () =>
                    new DealDamageToForwardsAndPlayers(
                        amountForward: 5000,
                        filterForward: (effect, forward) =>
                            forward.Controller != effect.Source.OwningCard.Controller
                    );
            })
            .ActivatedAbility(p =>
            {
            ...
            .ActivatedAbility(p =>
            {
                p.Text = "{R}{R}{1}{T}: Choose 1 Forward. Break it.";
