namespace CrystalArena.Tests.Cards
{
    ...
    public class PendrellFlux
    {
        ...
        {
            [Fact(Skip = "Old card")]
            public void ResurectedForwardIsNoLongerInfluencedByFlux()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(flux, target: bear),
                    ...
                    At(Step.SecondMain, turn: 2).Cast(shock, target: bear).Cast(exhume),
