    ...
    public class BodySnatcher
    {
        public class Predefined : PredefinedScenario
        {
            ...
            public void RemoveFromPlayBodySnatcher()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(snatcher),
                    At(Step.SecondMain).Verify(() => Equal(Zone.RemovedFromPlay, C(snatcher).Zone))
                );
            }
            ...
            public void PutForceToBattlefield()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(snatcher),
                    At(Step.DeclareAttackers).Cast(shock, target: snatcher).Target(force),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
