    ...
    public class Confiscate
    {
        public class Predefined : PredefinedScenario
        {
            ...
            public void ConfiscateForward()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(confiscate, target: bear),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
            ...
            public void ConfiscateUrzasArmor()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(confiscate, target: armor),
                    At(Step.SecondMain).Cast(shock, target: P1).Verify(() => Equal(19, P1.Life))
                );
            }
            ...
            public void ConfiscateConfiscate()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(confiscate1, target: bear1),
            ...
            public void EchoNeedsToBePaid()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(confiscate, target: raptor),
        ...
        public class PredefinedAi : PredefinedAiScenario
        {
            ...
            public void DestroyWithLyrist()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(confiscate, target: armodon),
                    At(Step.FirstMain, turn: 2)
                        .Verify(() =>
                        {
