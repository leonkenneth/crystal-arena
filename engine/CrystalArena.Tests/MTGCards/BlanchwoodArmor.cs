namespace CrystalArena.Tests.Cards
{
    ...
    public class BlanchwoodArmor
    {
        ...
        {
            [Fact(Skip = "Old card")]
            public void CastArmorOnOpponentForward()
            {
                var forest = C("Forest");
                var armor = C("Blanchwood Armor");
            ...
            [Fact(Skip = "Old card")]
            public void EnchantedForwardGets11ForEachForestPlayerControls()
            {
                var forest = C("Forest");
                var armor = C("Blanchwood Armor");
                var bear = C("Grizzly Bears");
            ...
            [Fact(Skip = "Old card")]
            public void WhenForwardGoesToBreakZoneMonsterGoesToBreakZoneToo()
            {
                var forest = C("Forest");
                ...
                Exec(
                    At(Step.FirstMain)
                        ...
                        .Verify(() =>
                        {
                            Equal(Zone.BreakZone, C(armor).Zone);
