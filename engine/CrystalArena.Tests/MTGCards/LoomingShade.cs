    ...
    public class LoomingShade
    {
        public class PredefinedAi : PredefinedAiScenario
        {
            ...
            public void BlockAndPump()
            {
                ...
                Exec(
                    At(Step.DeclareAttackers).DeclareAttackers(bears),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
                            Equal(20, P2.Life);
            ...
            public void DoNotBlockShade()
            {
                ...
                Exec(
                    At(Step.DeclareAttackers).DeclareAttackers(loomingShade),
                    At(Step.DeclareBlocker).Activate(loomingShade).Activate(loomingShade),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
                            Equal(17, P2.Life);
