                ...
                Exec(
                    At(Step.FirstMain)
                        ...
                        .Verify(() =>
                        {
                            ...
                            True(C(bear).HasProtectionFrom(CardColor.Dark));
                            True(C(bear).HasProtectionFrom(CardColor.Wind));
                        }),
                ...
                Exec(
                    ...
                    At(Step.FirstMain)
                        ...
                        .Verify(() =>
                        {
                            ...
                            True(C(bear2).HasProtectionFrom(CardColor.Dark));
                            False(C(bear1).HasProtectionFrom(CardColor.Dark));
                        })
                );
            }
        }
