    ...
    public class RagingRavine
    {
        public class Ai : AiScenario
        {
            ...
            public void BugDestroyRavine()
            {
                ...
                Equal(Zone.BreakZone, C(ravine).Zone);
            }
        ...
        public class Predefined : PredefinedScenario
        {
            ...
            public void AttackFor4()
            {
                ...
                Exec(
                    At(Step.FirstMain).Activate(ravine, abilityIndex: 1),
                    At(Step.DeclareAttackers).DeclareAttackers(ravine),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
                            Equal(16, P2.Life);
        ...
        {
            [Fact(Skip = "Old card")]
            public void DoNotChangeToForwardIfCannotBlock()
            {
                var ravine = C("Raging Ravine");
                ...
                Exec(
                    At(Step.DeclareAttackers).DeclareAttackers(charger1, charger2, charger3),
                    At(Step.SecondMain)
