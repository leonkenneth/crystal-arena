namespace CrystalArena.Tests.Cards
{
    ...
    public class SwordOfFireAndIce
    {
        public class Ai : AiScenario
        {
            ...
            {
                Battlefield(P1, C("Rumbling Slum").IsEquipedWith(C("Sword of Fire and Ice")));
                ...
                Exec(
                    At(Step.FirstMain)
                        ...
                        .Verify(() =>
                        {
                            ...
                            True(C(bear1).HasProtectionFrom(CardColor.Water));
                            True(C(bear1).HasProtectionFrom(CardColor.Fire));
                        }),
                    At(Step.DeclareAttackers).DeclareAttackers(bear1),
                    At(Step.CombatDamage).Target(bear2),
                    At(Step.SecondMain)
                        .Verify(() =>
                        {
