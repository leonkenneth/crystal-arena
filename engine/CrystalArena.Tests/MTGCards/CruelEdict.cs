    ...
    public class CruelEdict
    {
        public class Ai : AiScenario
        {
            ...
            public void KavuGetsSmashed()
            {
                ...
                Equal(Zone.BreakZone, C(edict).Zone);
                Equal(Zone.BreakZone, C(kavu).Zone);
            }
        }
        ...
        {
            [Fact(Skip = "Old card")]
            public void TargetOpponentSacrificesForward()
            {
                var edict = C("Cruel Edict");
                ...
                Exec(At(Step.FirstMain).Cast(edict).Verify(() => Equal(0, P2.Battlefield.Count())));
            }
        }
        ...
        public class PredefinedAi : PredefinedAiScenario
        {
            ...
            public void DoNotSackTitan()
            {
                ...
                Exec(
                    At(Step.FirstMain, turn: 3).Cast(edict),
