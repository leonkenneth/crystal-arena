    ...
    public class AvacynGuardianAngel
    {
        public class PredefinedAi : PredefinedAiScenario
        {
            ...
            public void PreventDamageFromRedSourceToPegasus()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(bolt, target: pegasus),
                    At(Step.SecondMain).Verify(() => Equal(Zone.Battlefield, C(pegasus).Zone))
                );
            }
            ...
            public void PreventDamageFromRedSourceToPlayer()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(bolt, target: P2),
            ...
            public void PreventDamageFromDragonToPegasus()
            {
                ...
                Battlefield(
                    P1,
                    dragon.IsEnchantedWith("Blanchwood Armor"),
                    "Grizzly Bears",
                    "Forest",
                    "Forest"
                );
