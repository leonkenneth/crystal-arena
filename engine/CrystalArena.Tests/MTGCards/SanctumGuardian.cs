namespace CrystalArena.Tests.Cards
{
    ...
    public class SanctumGuardian
    {
        public class Predefined : PredefinedScenario
        {
            ...
            public void PreventDamageFromBolt()
            {
                ...
                Exec(
                    At(Step.FirstMain)
                        ...
                        {
                            Equal(20, P2.Life);
                            Equal(Zone.BreakZone, C(guardian).Zone);
                        })
                );
            }
            ...
            public void PreventDamageOnlyOnce()
            {
                ...
                Exec(
                    ...
                    At(Step.DeclareBlocker).Activate(guardian, new ITarget[] { C(dragon), P2 }),
                    At(Step.SecondMain)
        ...
        {
            [Fact(Skip = "Old card")]
            public void TradeForBetterForward()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(bolt1, dragon).Cast(bolt2, dragon),
                    At(Step.SecondMain).Verify(() => Equal(Zone.Battlefield, C(dragon).Zone))
                );
            }
            ...
            public void PreventSpellDamageToPlayerOnce()
            {
                ...
                Exec(
                    At(Step.FirstMain).Cast(bolt, P2).Cast(shock, P2),
                    At(Step.SecondMain).Verify(() => Equal(1, P2.Life))
                );
            }
            ...
            public void PreventCombatDamage()
            {
                ...
                Exec(
                    At(Step.DeclareAttackers).DeclareAttackers(baloth1, baloth2),
                    At(Step.SecondMain).Verify(() => Equal(8, P2.Life))
                );
            }
        }
    }
