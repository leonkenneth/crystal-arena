  ...
  public class Scenarios : AiScenario
  {
    ...
    public void Num11()
    {
      ...
      Battlefield(P1, "Razorverge Thicket", "Student of Warfare", "Razorverge Thicket", "Forest",
        C("Troll Ascetic").IsEquipedWith("Sword of Feast and Famine"), "Sunpetal CrystalArena", "Sunpetal CrystalArena");

      Battlefield(P2, "Plains", "Plains", "Light Knight", "Plains", "Student of Warfare", "Plains", "Trip Noose",
    ...
    public void Num16()
    {
      ...
      Battlefield(P1, "Swamp", "Swamp", "Swamp", "Bog Raiders", "Phyrexian Ghoul", "Swamp", "Hopping Automaton", "Swamp",
        "Hopping Automaton");
      Battlefield(P2, "Plains", "Plains", "Rune of Protection: Dark", "Plains", "Sanctum Custodian");
    ...
    public void Num17()
    {
      ...
      Battlefield(P2, "Plains", "Plains", "Disciple of Grace", "Plains", "Plains", "Rune of Protection: Dark", "Plains");
    ...
    public void Num21()
    {
      ...
      Battlefield(P1, "Blasted Backupscape", "Island", "Swamp", "Phyrexian Ghoul", "Island", "Phyrexian Debaser", "Swamp",
