namespace CrystalArena.Tests.Performance
{
    ...
    public class Scenarios : AiScenario
    {
        ...
        public Scenarios(SearchParameters searchParameters)
        ...
        public void Num12()
        {
            Hand(P1, "Pestilence", "Voice of Grace", "Corrupt", "Rune of Protection: Dark");
        ...
        public void Num17()
        {
            ...
            Battlefield(
                ...
                "Swamp",
                "Swamp",
                C("Mana Leech").IsEnchantedWith("Pacifism"),
                "Swamp",
                "Pestilence",
                C("Carrion Beetles").IsEnchantedWith("Diabolic Servitude"),
                "Blood Vassal"
            );
            Battlefield(
                P2,
        ...
        public void Num18()
        {
            ...
            Battlefield(
                P2,
                C("Forest").IsEnchantedWith("Fertile Ground"),
                "Plains",
                "Plains",
                "Opal Acrolith",
                "Plains",
        ...
        public void Num20()
        {
            ...
            Battlefield(
                ...
                "Tragic Poet",
                "Plains",
                C("Expendable Troops").IsEnchantedWith("Brilliant Halo"),
                "Disciple of Grace",
                "Mountain",
                "Songstitcher",
                "Mountain",
        ...
        public void Num22()
        {
            ...
            Battlefield(
                ...
                "Island",
                "Swamp",
                C("Walking Sponge").IsEnchantedWith("Cessation"),
                "Island",
                "Jhoira's Toolbox",
                "Island",
                "Phyrexian Debaser",
        ...
        public void Num23()
        {
            ...
            Battlefield(
                P2,
                "Plains",
                C("Mother of Runes").IsEnchantedWith("Rancor").IsEnchantedWith("Cessation"),
                "Forest",
                "Forest",
                "Yavimaya Granger",
                "Forest",
        ...
        public void Num24()
        {
            ...
            Battlefield(
                ...
                "Island",
                "Island",
                C("Walking Sponge").IsEnchantedWith("Cloak of Mists").IsEnchantedWith("Launch"),
                "Island",
                "Forest",
                "Hopping Automaton"
            );
        ...
        public void Num25()
        {
            ...
            Battlefield(
                ...
                "Swamp",
                "Swamp",
                C("Fog of Gnats").IsEnchantedWith("Cessation"),
                "Forest",
                "Phyrexian Ghoul",
                "Forest",
                "Phyrexian Debaser",
