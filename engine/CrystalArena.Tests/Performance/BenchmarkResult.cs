namespace CrystalArena.Tests.Performance
{
    ...
    public class BenchmarkResult
    {
        ...
        private readonly List<BenchmarkRunResultComparision> _comparisions =
            new List<BenchmarkRunResultComparision>();
        ...
        public BenchmarkResult(BenchmarkRunResult newResult, BenchmarkRunResult baseResult)
        {
            ...
            foreach (var run in newResult.Runs)
            {
                ...
                _comparisions.Add(
                    new BenchmarkRunResultComparision(run.Name, run.Duration, baseDuration)
                );
            }
        }
        ...
        {
            get { return _newResult.Duration; }
        }
        private TimeSpan BaseDuration
        {
            get { return _baseResult.Duration; }
        }
        private double Improvement
        {
            get
            {
                return (BaseDuration - Duration).TotalMilliseconds
        ...
        public string PrettyPrint()
        {
            ...
            sb.AppendFormat(
                "Base: '{0}' recorded on {1}.\n",
                _baseResult.Name,
                _baseResult.RecordedAt
            );
        ...
        private class BenchmarkRunResultComparision
        {
            ...
            public BenchmarkRunResultComparision(
                string name,
                TimeSpan duration,
