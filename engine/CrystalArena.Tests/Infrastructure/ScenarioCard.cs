namespace CrystalArena.Tests.Infrastructure
{
    ...
    {
        private readonly List<ScenarioCard> _monsters = new List<ScenarioCard>();
        ...
        public IEnumerable<ScenarioCard> Monsters
        {
            get { return _monsters; }
        }
        public IEnumerable<ScenarioCard> Equipments
        {
        ...
        public IEnumerable<ScenarioCard> TrackedBy
        {
            get { return _trackedBy; }
        }
        ...
        public ScenarioCard IsEnchantedWith(params ScenarioCard[] monsters)
        {
