namespace CrystalArena.Tests.Infrastructure
{
    ...
    public abstract class Scenario : IDisposable
    {
        ...
        protected Scenario(
            bool player1ControlledByScript = true,
            bool player2ControlledByScript = true,
        ...
        )
        {
            ...
            var player1Controller = player1ControlledByScript
                ? PlayerType.Scenario
                : PlayerType.Machine;
            var player2Controller = player2ControlledByScript
                ? PlayerType.Scenario
                : PlayerType.Machine;
        ...
        private static void AddCounters(ScenarioCard scenarioCard, Card card)
        {
            ...
            {
                var p = new ModifierParameters { SourceCard = card };
        ...
        protected ScenarioEffect E(ScenarioCard scenarioCard)
        {
            ...
            {
                Effect = () => Game.Stack.First(x => x.Source.OwningCard == scenarioCard.Card),
            };
        }
