namespace CrystalArena.Tests.Infrastructure
{
    ...
    public abstract class AiScenario : Scenario
    {
        ...
        protected int AvarageTreeSize
        {
            get { return SearchCount > 0 ? TotalTreeSize / SearchCount : 0; }
        }

        protected double AvarageSpeed
        {
            get { return TotalNodeCount > 0 ? TotalNodeCount / TotalElapsedTime : 0; }
        }
        ...
        protected double MaxSearchTime
        {
            get
            {
                return _measurements.Any() ? _measurements.Max(x => x.ElapsedTime) / 1000.0d : 0;
            }
        }
        ...
        {
            get { return _measurements.Sum(x => x.TreeSize.Total); }
        }
